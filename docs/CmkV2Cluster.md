...
**spec** | [**CmkV2ClusterSpec**](CmkV2ClusterSpec.md) |  | [optional] 
...
json = "{}"
# create an instance of CmkV2Cluster from a JSON string
cmk_v2_cluster_instance = CmkV2Cluster.from_json(json)
# print the JSON string representation of the object
print CmkV2Cluster.to_json()

# convert the object into a dict
cmk_v2_cluster_dict = cmk_v2_cluster_instance.to_dict()
# create an instance of CmkV2Cluster from a dict
cmk_v2_cluster_form_dict = cmk_v2_cluster.from_dict(cmk_v2_cluster_dict)
```
