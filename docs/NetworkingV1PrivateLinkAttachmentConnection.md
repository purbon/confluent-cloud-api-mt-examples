...
json = "{}"
# create an instance of NetworkingV1PrivateLinkAttachmentConnection from a JSON string
networking_v1_private_link_attachment_connection_instance = NetworkingV1PrivateLinkAttachmentConnection.from_json(json)
# print the JSON string representation of the object
print NetworkingV1PrivateLinkAttachmentConnection.to_json()

# convert the object into a dict
networking_v1_private_link_attachment_connection_dict = networking_v1_private_link_attachment_connection_instance.to_dict()
# create an instance of NetworkingV1PrivateLinkAttachmentConnection from a dict
networking_v1_private_link_attachment_connection_form_dict = networking_v1_private_link_attachment_connection.from_dict(networking_v1_private_link_attachment_connection_dict)
```
