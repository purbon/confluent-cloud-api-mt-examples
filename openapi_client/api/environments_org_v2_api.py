...
class EnvironmentsOrgV2Api:
    ...
    @validate_arguments
    def create_org_v2_environment(self, create_org_v2_environment_request : Optional[CreateOrgV2EnvironmentRequest] = None, **kwargs) -> CreateOrgV2EnvironmentRequest:  # noqa: E501
        """Create an Environment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create an environment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_org_v2_environment(create_org_v2_environment_request, async_req=True)
        >>> result = thread.get()

        :param create_org_v2_environment_request:
        :type create_org_v2_environment_request: CreateOrgV2EnvironmentRequest
        ...
        :rtype: CreateOrgV2EnvironmentRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_org_v2_environment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_org_v2_environment_with_http_info(create_org_v2_environment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_org_v2_environment_with_http_info(self, create_org_v2_environment_request : Optional[CreateOrgV2EnvironmentRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an Environment  # noqa: E501
        ...
        >>> thread = api.create_org_v2_environment_with_http_info(create_org_v2_environment_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateOrgV2EnvironmentRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_org_v2_environment_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_org_v2_environment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_org_v2_environment_request'] is not None:
            _body_params = _params['create_org_v2_environment_request']
        ...
        _response_types_map = {
            '201': "CreateOrgV2EnvironmentRequest",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
    ...
    def delete_org_v2_environment(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_org_v2_environment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_org_v2_environment_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_org_v2_environment_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an Environment  # noqa: E501
        ...
        >>> thread = api.delete_org_v2_environment_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_org_v2_environment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_org_v2_environment(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], **kwargs) -> GetOrgV2Environment200Response:  # noqa: E501
        """Read an Environment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read an environment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_org_v2_environment(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetOrgV2Environment200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_org_v2_environment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_org_v2_environment_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_org_v2_environment_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Environment  # noqa: E501
        ...
        >>> thread = api.get_org_v2_environment_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetOrgV2Environment200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_org_v2_environment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetOrgV2Environment200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_org_v2_environments(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> OrgV2EnvironmentList:  # noqa: E501
        """List of Environments  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all environments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_org_v2_environments(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: OrgV2EnvironmentList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_org_v2_environments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_org_v2_environments_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_org_v2_environments_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Environments  # noqa: E501
        ...
        >>> thread = api.list_org_v2_environments_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(OrgV2EnvironmentList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_org_v2_environments" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_org_v2_environment(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], org_v2_environment : Optional[OrgV2Environment] = None, **kwargs) -> GetOrgV2Environment200Response:  # noqa: E501
        """Update an Environment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update an environment.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_org_v2_environment(id, org_v2_environment, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the environment. (required)
        :type id: str
        :param org_v2_environment:
        :type org_v2_environment: OrgV2Environment
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_org_v2_environment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_org_v2_environment_with_http_info(id, org_v2_environment, **kwargs)  # noqa: E501

    @validate_arguments
    def update_org_v2_environment_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the environment.")], org_v2_environment : Optional[OrgV2Environment] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update an Environment  # noqa: E501
        ...
        >>> thread = api.update_org_v2_environment_with_http_info(id, org_v2_environment, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_org_v2_environment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['org_v2_environment'] is not None:
            _body_params = _params['org_v2_environment']
