...
class ManagedConnectorPluginsConnectV1Api:
    ...
    @validate_arguments
    def list_connectv1_connector_plugins(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> List[ListConnectv1ConnectorPlugins200ResponseInner]:  # noqa: E501
        """List of Managed Connector plugins  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return a list of Managed Connector plugins installed in the Kafka Connect cluster.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_connectv1_connector_plugins(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: List[ListConnectv1ConnectorPlugins200ResponseInner]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_connectv1_connector_plugins_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_connectv1_connector_plugins_with_http_info(environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_connectv1_connector_plugins_with_http_info(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List of Managed Connector plugins  # noqa: E501
        ...
        >>> thread = api.list_connectv1_connector_plugins_with_http_info(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[ListConnectv1ConnectorPlugins200ResponseInner], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method list_connectv1_connector_plugins" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[ListConnectv1ConnectorPlugins200ResponseInner]",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connector-plugins', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def validate_connectv1_connector_plugin(self, plugin_name : Annotated[StrictStr, Field(..., description="The unique name of the connector plugin.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], request_body : Annotated[Optional[Dict[str, StrictStr]], Field(description="Configuration parameters for the connector. All values should be strings.")] = None, **kwargs) -> ValidateConnectv1ConnectorPlugin200Response:  # noqa: E501
        """Validate a Managed Connector Plugin  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Validate the provided configuration values against the configuration definition. This API performs per config validation and returns suggested values and validation error messages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.validate_connectv1_connector_plugin(plugin_name, environment_id, kafka_cluster_id, request_body, async_req=True)
        >>> result = thread.get()

        :param plugin_name: The unique name of the connector plugin. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ValidateConnectv1ConnectorPlugin200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the validate_connectv1_connector_plugin_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.validate_connectv1_connector_plugin_with_http_info(plugin_name, environment_id, kafka_cluster_id, request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def validate_connectv1_connector_plugin_with_http_info(self, plugin_name : Annotated[StrictStr, Field(..., description="The unique name of the connector plugin.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], request_body : Annotated[Optional[Dict[str, StrictStr]], Field(description="Configuration parameters for the connector. All values should be strings.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Validate a Managed Connector Plugin  # noqa: E501
        ...
        >>> thread = api.validate_connectv1_connector_plugin_with_http_info(plugin_name, environment_id, kafka_cluster_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ValidateConnectv1ConnectorPlugin200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method validate_connectv1_connector_plugin" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['plugin_name']:
            _path_params['plugin_name'] = _params['plugin_name']
        ...
        _response_types_map = {
            '200': "ValidateConnectv1ConnectorPlugin200Response",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "ConnectV1ConnectorError",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connector-plugins/{plugin_name}/config/validate', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
