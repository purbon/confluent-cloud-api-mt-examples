...
class PrivateLinkAttachmentConnectionsNetworkingV1Api:
    ...
    @validate_arguments
    def create_networking_v1_private_link_attachment_connection(self, create_networking_v1_private_link_attachment_connection_request : Optional[CreateNetworkingV1PrivateLinkAttachmentConnectionRequest] = None, **kwargs) -> CreateNetworkingV1PrivateLinkAttachmentConnection202Response:  # noqa: E501
        """Create a Private Link Attachment Connection  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a private link attachment connection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_networking_v1_private_link_attachment_connection(create_networking_v1_private_link_attachment_connection_request, async_req=True)
        >>> result = thread.get()

        :param create_networking_v1_private_link_attachment_connection_request:
        :type create_networking_v1_private_link_attachment_connection_request: CreateNetworkingV1PrivateLinkAttachmentConnectionRequest
        ...
        :rtype: CreateNetworkingV1PrivateLinkAttachmentConnection202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_networking_v1_private_link_attachment_connection_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_networking_v1_private_link_attachment_connection_with_http_info(create_networking_v1_private_link_attachment_connection_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_networking_v1_private_link_attachment_connection_with_http_info(self, create_networking_v1_private_link_attachment_connection_request : Optional[CreateNetworkingV1PrivateLinkAttachmentConnectionRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Private Link Attachment Connection  # noqa: E501
        ...
        >>> thread = api.create_networking_v1_private_link_attachment_connection_with_http_info(create_networking_v1_private_link_attachment_connection_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNetworkingV1PrivateLinkAttachmentConnection202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_networking_v1_private_link_attachment_connection_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_networking_v1_private_link_attachment_connection" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_networking_v1_private_link_attachment_connection_request'] is not None:
            _body_params = _params['create_networking_v1_private_link_attachment_connection_request']
        ...
        _response_types_map = {
            '202': "CreateNetworkingV1PrivateLinkAttachmentConnection202Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '409': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachment-connections', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_networking_v1_private_link_attachment_connection(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], **kwargs) -> None:  # noqa: E501
        """Delete a Private Link Attachment Connection  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a private link attachment connection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_networking_v1_private_link_attachment_connection(environment, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param id: The unique identifier for the private link attachment connection. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_networking_v1_private_link_attachment_connection_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_networking_v1_private_link_attachment_connection_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_networking_v1_private_link_attachment_connection_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Private Link Attachment Connection  # noqa: E501
        ...
        >>> thread = api.delete_networking_v1_private_link_attachment_connection_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_networking_v1_private_link_attachment_connection" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachment-connections/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_networking_v1_private_link_attachment_connection(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], **kwargs) -> GetNetworkingV1PrivateLinkAttachmentConnection200Response:  # noqa: E501
        """Read a Private Link Attachment Connection  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a private link attachment connection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_private_link_attachment_connection(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNetworkingV1PrivateLinkAttachmentConnection200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_private_link_attachment_connection_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_private_link_attachment_connection_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_private_link_attachment_connection_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Private Link Attachment Connection  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_private_link_attachment_connection_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1PrivateLinkAttachmentConnection200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_networking_v1_private_link_attachment_connection" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1PrivateLinkAttachmentConnection200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachment-connections/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_networking_v1_private_link_attachment_connections(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_private_link_attachment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.private_link_attachment.")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1PrivateLinkAttachmentConnections200Response:  # noqa: E501
        """List of Private Link Attachment Connections  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all private link attachment connections.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_networking_v1_private_link_attachment_connections(environment, spec_private_link_attachment, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param environment: Filter the results by exact match for environment. (required)
        :type environment: str
        :param spec_private_link_attachment: Filter the results by exact match for spec.private_link_attachment. (required)
        :type spec_private_link_attachment: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1PrivateLinkAttachmentConnections200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_private_link_attachment_connections_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_private_link_attachment_connections_with_http_info(environment, spec_private_link_attachment, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_private_link_attachment_connections_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_private_link_attachment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.private_link_attachment.")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Private Link Attachment Connections  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_private_link_attachment_connections_with_http_info(environment, spec_private_link_attachment, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1PrivateLinkAttachmentConnections200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_private_link_attachment_connections" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('spec_private_link_attachment') is not None:  # noqa: E501
            _query_params.append(('spec.private_link_attachment', _params['spec_private_link_attachment']))
        ...
        _response_types_map = {
            '200': "ListNetworkingV1PrivateLinkAttachmentConnections200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachment-connections', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_networking_v1_private_link_attachment_connection(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], update_networking_v1_private_link_attachment_connection_request : Optional[UpdateNetworkingV1PrivateLinkAttachmentConnectionRequest] = None, **kwargs) -> GetNetworkingV1PrivateLinkAttachmentConnection200Response:  # noqa: E501
        """Update a Private Link Attachment Connection  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a private link attachment connection.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_networking_v1_private_link_attachment_connection(id, update_networking_v1_private_link_attachment_connection_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the private link attachment connection. (required)
        :type id: str
        :param update_networking_v1_private_link_attachment_connection_request:
        :type update_networking_v1_private_link_attachment_connection_request: UpdateNetworkingV1PrivateLinkAttachmentConnectionRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_networking_v1_private_link_attachment_connection_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_networking_v1_private_link_attachment_connection_with_http_info(id, update_networking_v1_private_link_attachment_connection_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_networking_v1_private_link_attachment_connection_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment connection.")], update_networking_v1_private_link_attachment_connection_request : Optional[UpdateNetworkingV1PrivateLinkAttachmentConnectionRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Private Link Attachment Connection  # noqa: E501
        ...
        >>> thread = api.update_networking_v1_private_link_attachment_connection_with_http_info(id, update_networking_v1_private_link_attachment_connection_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_networking_v1_private_link_attachment_connection" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_networking_v1_private_link_attachment_connection_request'] is not None:
            _body_params = _params['update_networking_v1_private_link_attachment_connection_request']
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachment-connections/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
