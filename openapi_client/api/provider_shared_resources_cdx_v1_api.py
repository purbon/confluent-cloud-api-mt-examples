...
class ProviderSharedResourcesCdxV1Api:
    ...
    @validate_arguments
    def delete_image_cdx_v1_provider_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> None:  # noqa: E501
        """Delete the shared resource's image  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Deletes the image file for the shared resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_image_cdx_v1_provider_shared_resource(id, file_name, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the provider shared resource. (required)
        :type id: str
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_image_cdx_v1_provider_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_image_cdx_v1_provider_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete the shared resource's image  # noqa: E501
        ...
        >>> thread = api.delete_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_image_cdx_v1_provider_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources/{id}/images/{file_name}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_cdx_v1_provider_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], **kwargs) -> GetCdxV1ProviderSharedResource200Response:  # noqa: E501
        """Read a Provider Shared Resource  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a provider shared resource.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cdx_v1_provider_shared_resource(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetCdxV1ProviderSharedResource200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_cdx_v1_provider_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_cdx_v1_provider_shared_resource_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_cdx_v1_provider_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Provider Shared Resource  # noqa: E501
        ...
        >>> thread = api.get_cdx_v1_provider_shared_resource_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetCdxV1ProviderSharedResource200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cdx_v1_provider_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetCdxV1ProviderSharedResource200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_cdx_v1_provider_shared_resources(self, stream_share : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for stream_share.")] = None, crn : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for crn.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shared resources")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListCdxV1ProviderSharedResources200Response:  # noqa: E501
        """List of Provider Shared Resources  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all provider shared resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_cdx_v1_provider_shared_resources(stream_share, crn, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param stream_share: Filter the results by exact match for stream_share.
        :type stream_share: str
        :param crn: Filter the results by exact match for crn.
        :type crn: str
        :param include_deleted: Include deactivated shared resources
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListCdxV1ProviderSharedResources200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_cdx_v1_provider_shared_resources_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_cdx_v1_provider_shared_resources_with_http_info(stream_share, crn, include_deleted, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_cdx_v1_provider_shared_resources_with_http_info(self, stream_share : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for stream_share.")] = None, crn : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for crn.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shared resources")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Provider Shared Resources  # noqa: E501
        ...
        >>> thread = api.list_cdx_v1_provider_shared_resources_with_http_info(stream_share, crn, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListCdxV1ProviderSharedResources200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_cdx_v1_provider_shared_resources" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('stream_share') is not None:  # noqa: E501
            _query_params.append(('stream_share', _params['stream_share']))

        if _params.get('crn') is not None:  # noqa: E501
            _query_params.append(('crn', _params['crn']))
        ...
        _response_types_map = {
            '200': "ListCdxV1ProviderSharedResources200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_cdx_v1_provider_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], cdx_v1_provider_shared_resource_update : Optional[CdxV1ProviderSharedResourceUpdate] = None, **kwargs) -> GetCdxV1ProviderSharedResource200Response:  # noqa: E501
        """Update a Provider Shared Resource  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a provider shared resource.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_cdx_v1_provider_shared_resource(id, cdx_v1_provider_shared_resource_update, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the provider shared resource. (required)
        :type id: str
        :param cdx_v1_provider_shared_resource_update:
        :type cdx_v1_provider_shared_resource_update: CdxV1ProviderSharedResourceUpdate
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_cdx_v1_provider_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_cdx_v1_provider_shared_resource_with_http_info(id, cdx_v1_provider_shared_resource_update, **kwargs)  # noqa: E501

    @validate_arguments
    def update_cdx_v1_provider_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], cdx_v1_provider_shared_resource_update : Optional[CdxV1ProviderSharedResourceUpdate] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Provider Shared Resource  # noqa: E501
        ...
        >>> thread = api.update_cdx_v1_provider_shared_resource_with_http_info(id, cdx_v1_provider_shared_resource_update, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'cdx_v1_provider_shared_resource_update'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_cdx_v1_provider_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cdx_v1_provider_shared_resource_update'] is not None:
            _body_params = _params['cdx_v1_provider_shared_resource_update']
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def upload_image_cdx_v1_provider_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], body : Optional[StrictStr] = None, **kwargs) -> None:  # noqa: E501
        """Upload image for shared resource  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Upload the image file for the shared resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.upload_image_cdx_v1_provider_shared_resource(id, file_name, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the upload_image_cdx_v1_provider_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.upload_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, body, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_image_cdx_v1_provider_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], body : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Upload image for shared resource  # noqa: E501
        ...
        >>> thread = api.upload_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_image_cdx_v1_provider_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources/{id}/images/{file_name}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def view_image_cdx_v1_provider_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> bytearray:  # noqa: E501
        """Get image for shared resource  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Returns the image file for the shared resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.view_image_cdx_v1_provider_shared_resource(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the view_image_cdx_v1_provider_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.view_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, **kwargs)  # noqa: E501

    @validate_arguments
    def view_image_cdx_v1_provider_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the provider shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get image for shared resource  # noqa: E501
        ...
        >>> thread = api.view_image_cdx_v1_provider_shared_resource_with_http_info(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method view_image_cdx_v1_provider_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/provider-shared-resources/{id}/images/{file_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
