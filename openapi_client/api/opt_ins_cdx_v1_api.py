...
class OptInsCdxV1Api:
    ...
    @validate_arguments
    def get_cdx_v1_opt_in(self, **kwargs) -> GetCdxV1OptIn200Response:  # noqa: E501
        """Read the organization's stream sharing opt-in settings  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Returns the organization's stream sharing opt-in settings.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cdx_v1_opt_in(async_req=True)
        >>> result = thread.get()
        ...
        :rtype: GetCdxV1OptIn200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_cdx_v1_opt_in_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_cdx_v1_opt_in_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_cdx_v1_opt_in_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Read the organization's stream sharing opt-in settings  # noqa: E501
        ...
        >>> thread = api.get_cdx_v1_opt_in_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetCdxV1OptIn200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_cdx_v1_opt_in" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_cdx_v1_opt_in(self, cdx_v1_opt_in : Optional[CdxV1OptIn] = None, **kwargs) -> GetCdxV1OptIn200Response:  # noqa: E501
        """Set the organization's stream sharing opt-in settings  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Updates the organization's stream sharing opt-in settings.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_cdx_v1_opt_in(cdx_v1_opt_in, async_req=True)
        >>> result = thread.get()

        :param cdx_v1_opt_in:
        :type cdx_v1_opt_in: CdxV1OptIn
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_cdx_v1_opt_in_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_cdx_v1_opt_in_with_http_info(cdx_v1_opt_in, **kwargs)  # noqa: E501

    @validate_arguments
    def update_cdx_v1_opt_in_with_http_info(self, cdx_v1_opt_in : Optional[CdxV1OptIn] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Set the organization's stream sharing opt-in settings  # noqa: E501
        ...
        >>> thread = api.update_cdx_v1_opt_in_with_http_info(cdx_v1_opt_in, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_cdx_v1_opt_in" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['cdx_v1_opt_in'] is not None:
            _body_params = _params['cdx_v1_opt_in']
