...
class TopicV3Api:
    ...
    @validate_arguments
    def create_kafka_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_topic_request_data : Annotated[Optional[CreateTopicRequestData], Field(description="The topic creation request. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).")] = None, **kwargs) -> TopicData:  # noqa: E501
        """Create Topic  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Create a topic. Also supports a dry-run mode that only validates whether the topic creation would succeed if the ``validate_only`` request property is explicitly specified and set to true. Note that when dry-run mode is being used the response status would be 200 OK instead of 201 Created.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_kafka_topic(cluster_id, create_topic_request_data, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param create_topic_request_data: The topic creation request. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).
        :type create_topic_request_data: CreateTopicRequestData
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_kafka_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_kafka_topic_with_http_info(cluster_id, create_topic_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def create_kafka_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_topic_request_data : Annotated[Optional[CreateTopicRequestData], Field(description="The topic creation request. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create Topic  # noqa: E501
        ...
        >>> thread = api.create_kafka_topic_with_http_info(cluster_id, create_topic_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TopicData, status_code(int), headers(HTTPHeaderDict))
        """

        _hosts = [
            'https://pkc-75m1o.europe-west3.gcp.confluent.cloud:443'
        ]
        _host = _hosts[0]
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method create_kafka_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_topic_request_data'] is not None:
            _body_params = _params['create_topic_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_kafka_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], **kwargs) -> None:  # noqa: E501
        """Delete Topic  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Delete the topic with the given `topic_name`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_kafka_topic(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_kafka_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_kafka_topic_with_http_info(cluster_id, topic_name, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_kafka_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete Topic  # noqa: E501
        ...
        >>> thread = api.delete_kafka_topic_with_http_info(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_kafka_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_kafka_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], include_authorized_operations : Annotated[Optional[StrictBool], Field(description="Specify if authorized operations should be included in the response.")] = None, **kwargs) -> TopicData:  # noqa: E501
        """Get Topic  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return the topic with the given `topic_name`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_kafka_topic(cluster_id, topic_name, include_authorized_operations, async_req=True)
        >>> result = thread.get()
        ...
        :param topic_name: The topic name. (required)
        :type topic_name: str
        :param include_authorized_operations: Specify if authorized operations should be included in the response.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_kafka_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_kafka_topic_with_http_info(cluster_id, topic_name, include_authorized_operations, **kwargs)  # noqa: E501

    @validate_arguments
    def get_kafka_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], include_authorized_operations : Annotated[Optional[StrictBool], Field(description="Specify if authorized operations should be included in the response.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Topic  # noqa: E501
        ...
        >>> thread = api.get_kafka_topic_with_http_info(cluster_id, topic_name, include_authorized_operations, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_kafka_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('include_authorized_operations') is not None:  # noqa: E501
            _query_params.append(('include_authorized_operations', _params['include_authorized_operations']))
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_topics(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], **kwargs) -> TopicDataList:  # noqa: E501
        """List Topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return the list of topics that belong to the specified Kafka cluster.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_topics(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_topics_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_topics_with_http_info(cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_topics_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List Topics  # noqa: E501
        ...
        >>> thread = api.list_kafka_topics_with_http_info(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TopicDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_topics" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_partition_count_kafka_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], update_partition_count_request_data : Optional[UpdatePartitionCountRequestData] = None, **kwargs) -> TopicData:  # noqa: E501
        """Update Partition Count  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Increase the number of partitions for a topic.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_partition_count_kafka_topic(cluster_id, topic_name, update_partition_count_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :param topic_name: The topic name. (required)
        :type topic_name: str
        :param update_partition_count_request_data:
        :type update_partition_count_request_data: UpdatePartitionCountRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_partition_count_kafka_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_partition_count_kafka_topic_with_http_info(cluster_id, topic_name, update_partition_count_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_partition_count_kafka_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], update_partition_count_request_data : Optional[UpdatePartitionCountRequestData] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update Partition Count  # noqa: E501
        ...
        >>> thread = api.update_partition_count_kafka_topic_with_http_info(cluster_id, topic_name, update_partition_count_request_data, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'cluster_id',
            'topic_name',
            'update_partition_count_request_data'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_partition_count_kafka_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_partition_count_request_data'] is not None:
            _body_params = _params['update_partition_count_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
