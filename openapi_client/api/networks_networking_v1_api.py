...
class NetworksNetworkingV1Api:
    ...
    @validate_arguments
    def create_networking_v1_network(self, create_networking_v1_network_request : Optional[CreateNetworkingV1NetworkRequest] = None, **kwargs) -> CreateNetworkingV1Network202Response:  # noqa: E501
        """Create a Network  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_networking_v1_network(create_networking_v1_network_request, async_req=True)
        >>> result = thread.get()

        :param create_networking_v1_network_request:
        :type create_networking_v1_network_request: CreateNetworkingV1NetworkRequest
        ...
        :rtype: CreateNetworkingV1Network202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_networking_v1_network_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_networking_v1_network_with_http_info(create_networking_v1_network_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_networking_v1_network_with_http_info(self, create_networking_v1_network_request : Optional[CreateNetworkingV1NetworkRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Network  # noqa: E501
        ...
        >>> thread = api.create_networking_v1_network_with_http_info(create_networking_v1_network_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNetworkingV1Network202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_networking_v1_network_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_networking_v1_network" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_networking_v1_network_request'] is not None:
            _body_params = _params['create_networking_v1_network_request']
        ...
        _response_types_map = {
            '202': "CreateNetworkingV1Network202Response",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
    ...
    @validate_arguments
    def delete_networking_v1_network(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], **kwargs) -> None:  # noqa: E501
        """Delete a Network  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_networking_v1_network(environment, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param id: The unique identifier for the network. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_networking_v1_network_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_networking_v1_network_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_networking_v1_network_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Network  # noqa: E501
        ...
        >>> thread = api.delete_networking_v1_network_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_networking_v1_network" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/networking/v1/networks/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_networking_v1_network(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], **kwargs) -> GetNetworkingV1Network200Response:  # noqa: E501
        """Read a Network  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a network.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_network(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNetworkingV1Network200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_network_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_network_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_network_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Network  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_network_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1Network200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_networking_v1_network" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1Network200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_networking_v1_networks(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, spec_cloud : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cloud. Pass multiple times to see results matching any of the values.")] = None, spec_region : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.region. Pass multiple times to see results matching any of the values.")] = None, spec_cidr : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cidr. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, connection_type : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for connection_type. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1Networks200Response:  # noqa: E501
        """List of Networks  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all networks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_networking_v1_networks(environment, spec_display_name, spec_cloud, spec_region, spec_cidr, status_phase, connection_type, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :param spec_cidr: Filter the results by exact match for spec.cidr. Pass multiple times to see results matching any of the values.
        :type spec_cidr: List[str]
        ...
        :param connection_type: Filter the results by exact match for connection_type. Pass multiple times to see results matching any of the values.
        :type connection_type: List[str]
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1Networks200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_networks_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_networks_with_http_info(environment, spec_display_name, spec_cloud, spec_region, spec_cidr, status_phase, connection_type, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_networks_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, spec_cloud : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cloud. Pass multiple times to see results matching any of the values.")] = None, spec_region : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.region. Pass multiple times to see results matching any of the values.")] = None, spec_cidr : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cidr. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, connection_type : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for connection_type. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Networks  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_networks_with_http_info(environment, spec_display_name, spec_cloud, spec_region, spec_cidr, status_phase, connection_type, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1Networks200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_networks" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('spec_cidr') is not None:  # noqa: E501
            _query_params.append(('spec.cidr', _params['spec_cidr']))
            _collection_formats['spec.cidr'] = 'multi'
        ...
        if _params.get('connection_type') is not None:  # noqa: E501
            ...
            _collection_formats['connection_type'] = 'multi'
        ...
        _response_types_map = {
            '200': "ListNetworkingV1Networks200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
    ...
    @validate_arguments
    def update_networking_v1_network(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], update_networking_v1_network_request : Optional[UpdateNetworkingV1NetworkRequest] = None, **kwargs) -> GetNetworkingV1Network200Response:  # noqa: E501
        """Update a Network  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a network.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_networking_v1_network(id, update_networking_v1_network_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the network. (required)
        :type id: str
        :param update_networking_v1_network_request:
        :type update_networking_v1_network_request: UpdateNetworkingV1NetworkRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_networking_v1_network_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_networking_v1_network_with_http_info(id, update_networking_v1_network_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_networking_v1_network_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the network.")], update_networking_v1_network_request : Optional[UpdateNetworkingV1NetworkRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Network  # noqa: E501
        ...
        >>> thread = api.update_networking_v1_network_with_http_info(id, update_networking_v1_network_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'update_networking_v1_network_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_networking_v1_network" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_networking_v1_network_request'] is not None:
            _body_params = _params['update_networking_v1_network_request']
        ...
        return self.api_client.call_api(
            '/networking/v1/networks/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
