...
class NetworkLinkServiceAssociationsNetworkingV1Api:
    ...
    @validate_arguments
    def get_networking_v1_network_link_service_association(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the network link service association.")], **kwargs) -> GetNetworkingV1NetworkLinkServiceAssociation200Response:  # noqa: E501
        """Read a Network Link Service Association  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a network link service association.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_network_link_service_association(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the network link service association. (required)
        :type id: str
        ...
        :rtype: GetNetworkingV1NetworkLinkServiceAssociation200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_network_link_service_association_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_network_link_service_association_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_network_link_service_association_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the network link service association.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Network Link Service Association  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_network_link_service_association_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1NetworkLinkServiceAssociation200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_networking_v1_network_link_service_association" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1NetworkLinkServiceAssociation200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/network-link-service-associations/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_networking_v1_network_link_service_associations(self, spec_network_link_service : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.network_link_service.")], environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1NetworkLinkServiceAssociations200Response:  # noqa: E501
        """List of Network Link Service Associations  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all network link service associations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_networking_v1_network_link_service_associations(spec_network_link_service, environment, status_phase, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param spec_network_link_service: Filter the results by exact match for spec.network_link_service. (required)
        :type spec_network_link_service: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1NetworkLinkServiceAssociations200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_network_link_service_associations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_network_link_service_associations_with_http_info(spec_network_link_service, environment, status_phase, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_network_link_service_associations_with_http_info(self, spec_network_link_service : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.network_link_service.")], environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Network Link Service Associations  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_network_link_service_associations_with_http_info(spec_network_link_service, environment, status_phase, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1NetworkLinkServiceAssociations200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_network_link_service_associations" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListNetworkingV1NetworkLinkServiceAssociations200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
