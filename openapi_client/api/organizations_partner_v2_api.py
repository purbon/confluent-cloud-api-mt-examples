...
class OrganizationsPartnerV2Api:
    ...
    def get_partner_v2_organization(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], **kwargs) -> GetPartnerV2Organization200Response:  # noqa: E501
        ...
        :rtype: GetPartnerV2Organization200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_partner_v2_organization_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_partner_v2_organization_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_partner_v2_organization_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Organization  # noqa: E501
        ...
        >>> thread = api.get_partner_v2_organization_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetPartnerV2Organization200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_partner_v2_organization" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetPartnerV2Organization200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/partner/v2/organizations/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def list_partner_v2_organizations(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> PartnerV2OrganizationList:  # noqa: E501
        ...
        >>> thread = api.list_partner_v2_organizations(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PartnerV2OrganizationList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_partner_v2_organizations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_partner_v2_organizations_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_partner_v2_organizations_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Organizations  # noqa: E501
        ...
        >>> thread = api.list_partner_v2_organizations_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PartnerV2OrganizationList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_partner_v2_organizations" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
