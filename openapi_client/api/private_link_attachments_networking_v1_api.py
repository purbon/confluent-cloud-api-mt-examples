...
class PrivateLinkAttachmentsNetworkingV1Api:
    ...
    @validate_arguments
    def create_networking_v1_private_link_attachment(self, create_networking_v1_private_link_attachment_request : Optional[CreateNetworkingV1PrivateLinkAttachmentRequest] = None, **kwargs) -> CreateNetworkingV1PrivateLinkAttachment202Response:  # noqa: E501
        """Create a Private Link Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a private link attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_networking_v1_private_link_attachment(create_networking_v1_private_link_attachment_request, async_req=True)
        >>> result = thread.get()

        :param create_networking_v1_private_link_attachment_request:
        :type create_networking_v1_private_link_attachment_request: CreateNetworkingV1PrivateLinkAttachmentRequest
        ...
        :rtype: CreateNetworkingV1PrivateLinkAttachment202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_networking_v1_private_link_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_networking_v1_private_link_attachment_with_http_info(create_networking_v1_private_link_attachment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_networking_v1_private_link_attachment_with_http_info(self, create_networking_v1_private_link_attachment_request : Optional[CreateNetworkingV1PrivateLinkAttachmentRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Private Link Attachment  # noqa: E501
        ...
        >>> thread = api.create_networking_v1_private_link_attachment_with_http_info(create_networking_v1_private_link_attachment_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNetworkingV1PrivateLinkAttachment202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_networking_v1_private_link_attachment_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_networking_v1_private_link_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_networking_v1_private_link_attachment_request'] is not None:
            _body_params = _params['create_networking_v1_private_link_attachment_request']
        ...
        _response_types_map = {
            '202': "CreateNetworkingV1PrivateLinkAttachment202Response",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachments', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_networking_v1_private_link_attachment(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], **kwargs) -> None:  # noqa: E501
        """Delete a Private Link Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a private link attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_networking_v1_private_link_attachment(environment, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param id: The unique identifier for the private link attachment. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_networking_v1_private_link_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_networking_v1_private_link_attachment_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_networking_v1_private_link_attachment_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Private Link Attachment  # noqa: E501
        ...
        >>> thread = api.delete_networking_v1_private_link_attachment_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_networking_v1_private_link_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachments/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_networking_v1_private_link_attachment(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], **kwargs) -> GetNetworkingV1PrivateLinkAttachment200Response:  # noqa: E501
        """Read a Private Link Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a private link attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_private_link_attachment(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNetworkingV1PrivateLinkAttachment200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_private_link_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_private_link_attachment_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_private_link_attachment_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Private Link Attachment  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_private_link_attachment_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1PrivateLinkAttachment200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_networking_v1_private_link_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1PrivateLinkAttachment200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachments/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_networking_v1_private_link_attachments(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, spec_cloud : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cloud. Pass multiple times to see results matching any of the values.")] = None, spec_region : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.region. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1PrivateLinkAttachments200Response:  # noqa: E501
        """List of Private Link Attachments  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all private link attachments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_networking_v1_private_link_attachments(environment, spec_display_name, spec_cloud, spec_region, status_phase, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param environment: Filter the results by exact match for environment. (required)
        :type environment: str
        :param spec_display_name: Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.
        :type spec_display_name: List[str]
        :param spec_cloud: Filter the results by exact match for spec.cloud. Pass multiple times to see results matching any of the values.
        :type spec_cloud: List[str]
        :param spec_region: Filter the results by exact match for spec.region. Pass multiple times to see results matching any of the values.
        :type spec_region: List[str]
        :param status_phase: Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.
        :type status_phase: List[str]
        :param page_size: A pagination size for collection requests.
        :type page_size: int
        :param page_token: An opaque pagination token for collection requests.
        :type page_token: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1PrivateLinkAttachments200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_private_link_attachments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_private_link_attachments_with_http_info(environment, spec_display_name, spec_cloud, spec_region, status_phase, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_private_link_attachments_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, spec_cloud : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.cloud. Pass multiple times to see results matching any of the values.")] = None, spec_region : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.region. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Private Link Attachments  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_private_link_attachments_with_http_info(environment, spec_display_name, spec_cloud, spec_region, status_phase, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1PrivateLinkAttachments200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_private_link_attachments" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('spec_display_name') is not None:  # noqa: E501
            _query_params.append(('spec.display_name', _params['spec_display_name']))
            _collection_formats['spec.display_name'] = 'multi'

        if _params.get('spec_cloud') is not None:  # noqa: E501
            _query_params.append(('spec.cloud', _params['spec_cloud']))
            _collection_formats['spec.cloud'] = 'multi'

        if _params.get('spec_region') is not None:  # noqa: E501
            _query_params.append(('spec.region', _params['spec_region']))
            _collection_formats['spec.region'] = 'multi'

        if _params.get('status_phase') is not None:  # noqa: E501
            _query_params.append(('status.phase', _params['status_phase']))
            _collection_formats['status.phase'] = 'multi'
        ...
        _response_types_map = {
            '200': "ListNetworkingV1PrivateLinkAttachments200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachments', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_networking_v1_private_link_attachment(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], update_networking_v1_private_link_attachment_request : Optional[UpdateNetworkingV1PrivateLinkAttachmentRequest] = None, **kwargs) -> GetNetworkingV1PrivateLinkAttachment200Response:  # noqa: E501
        """Update a Private Link Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a private link attachment.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_networking_v1_private_link_attachment(id, update_networking_v1_private_link_attachment_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the private link attachment. (required)
        :type id: str
        :param update_networking_v1_private_link_attachment_request:
        :type update_networking_v1_private_link_attachment_request: UpdateNetworkingV1PrivateLinkAttachmentRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_networking_v1_private_link_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_networking_v1_private_link_attachment_with_http_info(id, update_networking_v1_private_link_attachment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_networking_v1_private_link_attachment_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the private link attachment.")], update_networking_v1_private_link_attachment_request : Optional[UpdateNetworkingV1PrivateLinkAttachmentRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Private Link Attachment  # noqa: E501
        ...
        >>> thread = api.update_networking_v1_private_link_attachment_with_http_info(id, update_networking_v1_private_link_attachment_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'update_networking_v1_private_link_attachment_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_networking_v1_private_link_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_networking_v1_private_link_attachment_request'] is not None:
            _body_params = _params['update_networking_v1_private_link_attachment_request']
        ...
        return self.api_client.call_api(
            '/networking/v1/private-link-attachments/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
