...
class LifecycleConnectV1Api:
    ...
    @validate_arguments
    def pause_connectv1_connector(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> None:  # noqa: E501
        """Pause a Connector  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Pause the connector and its tasks. Stops message processing until the connector is resumed. This call is asynchronous and the tasks will not transition to PAUSED state at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pause_connectv1_connector(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the pause_connectv1_connector_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.pause_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def pause_connectv1_connector_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Pause a Connector  # noqa: E501
        ...
        >>> thread = api.pause_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method pause_connectv1_connector" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/pause', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def resume_connectv1_connector(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> None:  # noqa: E501
        """Resume a Connector  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Resume a paused connector or do nothing if the connector is not paused. This call is asynchronous and the tasks will not transition to RUNNING state at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.resume_connectv1_connector(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the resume_connectv1_connector_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.resume_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def resume_connectv1_connector_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Resume a Connector  # noqa: E501
        ...
        >>> thread = api.resume_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resume_connectv1_connector" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/resume', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
