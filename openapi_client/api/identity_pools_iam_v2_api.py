...
class IdentityPoolsIamV2Api:
    ...
    @validate_arguments
    def create_iam_v2_identity_pool(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], create_iam_v2_identity_pool_request : Optional[CreateIamV2IdentityPoolRequest] = None, **kwargs) -> CreateIamV2IdentityPoolRequest:  # noqa: E501
        """Create an Identity Pool  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create an identity pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_identity_pool(provider_id, create_iam_v2_identity_pool_request, async_req=True)
        >>> result = thread.get()

        :param provider_id: The Provider (required)
        :type provider_id: str
        :param create_iam_v2_identity_pool_request:
        :type create_iam_v2_identity_pool_request: CreateIamV2IdentityPoolRequest
        ...
        :rtype: CreateIamV2IdentityPoolRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_iam_v2_identity_pool_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_iam_v2_identity_pool_with_http_info(provider_id, create_iam_v2_identity_pool_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_iam_v2_identity_pool_with_http_info(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], create_iam_v2_identity_pool_request : Optional[CreateIamV2IdentityPoolRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an Identity Pool  # noqa: E501
        ...
        >>> thread = api.create_iam_v2_identity_pool_with_http_info(provider_id, create_iam_v2_identity_pool_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateIamV2IdentityPoolRequest, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            'provider_id',
            'create_iam_v2_identity_pool_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_iam_v2_identity_pool" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_iam_v2_identity_pool_request'] is not None:
            _body_params = _params['create_iam_v2_identity_pool_request']
        ...
        _response_types_map = {
            '201': "CreateIamV2IdentityPoolRequest",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/identity-providers/{provider_id}/identity-pools', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_iam_v2_identity_pool(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], **kwargs) -> None:  # noqa: E501
        """Delete an Identity Pool  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete an identity pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_iam_v2_identity_pool(provider_id, id, async_req=True)
        >>> result = thread.get()

        :param provider_id: The Provider (required)
        :type provider_id: str
        :param id: The unique identifier for the identity pool. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_iam_v2_identity_pool_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_iam_v2_identity_pool_with_http_info(provider_id, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_iam_v2_identity_pool_with_http_info(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an Identity Pool  # noqa: E501
        ...
        >>> thread = api.delete_iam_v2_identity_pool_with_http_info(provider_id, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_iam_v2_identity_pool" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_iam_v2_identity_pool(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], **kwargs) -> GetIamV2IdentityPool200Response:  # noqa: E501
        """Read an Identity Pool  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read an identity pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_iam_v2_identity_pool(provider_id, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetIamV2IdentityPool200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_iam_v2_identity_pool_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_iam_v2_identity_pool_with_http_info(provider_id, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_iam_v2_identity_pool_with_http_info(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Identity Pool  # noqa: E501
        ...
        >>> thread = api.get_iam_v2_identity_pool_with_http_info(provider_id, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetIamV2IdentityPool200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_iam_v2_identity_pool" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetIamV2IdentityPool200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_iam_v2_identity_pools(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> IamV2IdentityPoolList:  # noqa: E501
        """List of Identity Pools  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all identity pools.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_identity_pools(provider_id, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IamV2IdentityPoolList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_iam_v2_identity_pools_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_iam_v2_identity_pools_with_http_info(provider_id, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_iam_v2_identity_pools_with_http_info(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Identity Pools  # noqa: E501
        ...
        >>> thread = api.list_iam_v2_identity_pools_with_http_info(provider_id, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IamV2IdentityPoolList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_iam_v2_identity_pools" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/iam/v2/identity-providers/{provider_id}/identity-pools', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_iam_v2_identity_pool(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], iam_v2_identity_pool : Optional[IamV2IdentityPool] = None, **kwargs) -> GetIamV2IdentityPool200Response:  # noqa: E501
        """Update an Identity Pool  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update an identity pool.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_iam_v2_identity_pool(provider_id, id, iam_v2_identity_pool, async_req=True)
        >>> result = thread.get()
        ...
        :param id: The unique identifier for the identity pool. (required)
        :type id: str
        :param iam_v2_identity_pool:
        :type iam_v2_identity_pool: IamV2IdentityPool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_iam_v2_identity_pool_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_iam_v2_identity_pool_with_http_info(provider_id, id, iam_v2_identity_pool, **kwargs)  # noqa: E501

    @validate_arguments
    def update_iam_v2_identity_pool_with_http_info(self, provider_id : Annotated[StrictStr, Field(..., description="The Provider")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the identity pool.")], iam_v2_identity_pool : Optional[IamV2IdentityPool] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update an Identity Pool  # noqa: E501
        ...
        >>> thread = api.update_iam_v2_identity_pool_with_http_info(provider_id, id, iam_v2_identity_pool, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_iam_v2_identity_pool" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['iam_v2_identity_pool'] is not None:
            _body_params = _params['iam_v2_identity_pool']
        ...
        return self.api_client.call_api(
            '/iam/v2/identity-providers/{provider_id}/identity-pools/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
