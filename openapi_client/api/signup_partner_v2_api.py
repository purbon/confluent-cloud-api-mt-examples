...
class SignupPartnerV2Api:
    ...
    def activate_signup(self, activate_partner_signup_request : Annotated[Optional[ActivatePartnerSignupRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> PartnerSignupResponse:  # noqa: E501
        ...
        :rtype: PartnerSignupResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the activate_signup_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.activate_signup_with_http_info(activate_partner_signup_request, **kwargs)  # noqa: E501

    @validate_arguments
    def activate_signup_with_http_info(self, activate_partner_signup_request : Annotated[Optional[ActivatePartnerSignupRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Activate an Incomplete Signup  # noqa: E501
        ...
        >>> thread = api.activate_signup_with_http_info(activate_partner_signup_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PartnerSignupResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'activate_partner_signup_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method activate_signup" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['activate_partner_signup_request'] is not None:
            _body_params = _params['activate_partner_signup_request']
        ...
        return self.api_client.call_api(
            '/partner/v2/signup/activate', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def signup(self, dry_run : Annotated[Optional[StrictBool], Field(description="If true, only perform validation of signup")] = None, partner_signup_request : Annotated[Optional[PartnerSignupRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> PartnerSignupResponse:  # noqa: E501
        """Signup an Organization on behalf of a Customer  # noqa: E501
        ...
        >>> thread = api.signup(dry_run, partner_signup_request, async_req=True)
        >>> result = thread.get()

        :param dry_run: If true, only perform validation of signup
        :type dry_run: bool
        :param partner_signup_request: A JSON object containing signup information
        :type partner_signup_request: PartnerSignupRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the signup_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.signup_with_http_info(dry_run, partner_signup_request, **kwargs)  # noqa: E501

    @validate_arguments
    def signup_with_http_info(self, dry_run : Annotated[Optional[StrictBool], Field(description="If true, only perform validation of signup")] = None, partner_signup_request : Annotated[Optional[PartnerSignupRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Signup an Organization on behalf of a Customer  # noqa: E501
        ...
        >>> thread = api.signup_with_http_info(dry_run, partner_signup_request, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('dry_run') is not None:  # noqa: E501
            _query_params.append(('dry_run', _params['dry_run']))
        ...
        # process the body parameter
        _body_params = None
        if _params['partner_signup_request'] is not None:
            _body_params = _params['partner_signup_request']
    ...
    @validate_arguments
    def signup_partner_v2_link(self, dry_run : Annotated[Optional[StrictBool], Field(description="If true, only perform validation of signup")] = None, partner_link_request : Annotated[Optional[PartnerLinkRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> PartnerSignupResponse:  # noqa: E501
        """Signup a Customer by Linking to an Existing Organization  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Partner v2](https://img.shields.io/badge/-Request%20Access%20To%20Partner%20v2-%23bc8540)](mailto:ccloud-api-access+partner-v2-early-access@confluent.io?subject=Request%20to%20join%20partner/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20partner/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Signup a customer by linking a new entitlement to an existing Confluent Cloud organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.signup_partner_v2_link(dry_run, partner_link_request, async_req=True)
        >>> result = thread.get()

        :param dry_run: If true, only perform validation of signup
        :type dry_run: bool
        :param partner_link_request: A JSON object containing signup information
        :type partner_link_request: PartnerLinkRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the signup_partner_v2_link_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.signup_partner_v2_link_with_http_info(dry_run, partner_link_request, **kwargs)  # noqa: E501

    @validate_arguments
    def signup_partner_v2_link_with_http_info(self, dry_run : Annotated[Optional[StrictBool], Field(description="If true, only perform validation of signup")] = None, partner_link_request : Annotated[Optional[PartnerLinkRequest], Field(description="A JSON object containing signup information")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Signup a Customer by Linking to an Existing Organization  # noqa: E501
        ...
        >>> thread = api.signup_partner_v2_link_with_http_info(dry_run, partner_link_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method signup_partner_v2_link" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['partner_link_request'] is not None:
            _body_params = _params['partner_link_request']
