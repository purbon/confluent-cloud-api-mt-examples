...
class RegionsSrcmV2Api:
    ...
    @validate_arguments
    def get_srcm_v2_region(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the region.")], **kwargs) -> GetSrcmV2Region200Response:  # noqa: E501
        """Read a Region  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a region.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_srcm_v2_region(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the region. (required)
        :type id: str
        ...
        :rtype: GetSrcmV2Region200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_srcm_v2_region_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_srcm_v2_region_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_srcm_v2_region_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the region.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Region  # noqa: E501
        ...
        >>> thread = api.get_srcm_v2_region_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetSrcmV2Region200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_srcm_v2_region" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetSrcmV2Region200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_srcm_v2_regions(self, spec_cloud : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for spec.cloud.")] = None, spec_region_name : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for spec.region_name.")] = None, spec_packages : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.packages. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> SrcmV2RegionList:  # noqa: E501
        """List of Regions  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all regions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_srcm_v2_regions(spec_cloud, spec_region_name, spec_packages, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param spec_cloud: Filter the results by exact match for spec.cloud.
        :type spec_cloud: str
        :param spec_region_name: Filter the results by exact match for spec.region_name.
        :type spec_region_name: str
        :param spec_packages: Filter the results by exact match for spec.packages. Pass multiple times to see results matching any of the values.
        :type spec_packages: List[str]
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: SrcmV2RegionList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_srcm_v2_regions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_srcm_v2_regions_with_http_info(spec_cloud, spec_region_name, spec_packages, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_srcm_v2_regions_with_http_info(self, spec_cloud : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for spec.cloud.")] = None, spec_region_name : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for spec.region_name.")] = None, spec_packages : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.packages. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Regions  # noqa: E501
        ...
        >>> thread = api.list_srcm_v2_regions_with_http_info(spec_cloud, spec_region_name, spec_packages, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SrcmV2RegionList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_srcm_v2_regions" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('spec_region_name') is not None:  # noqa: E501
            _query_params.append(('spec.region_name', _params['spec_region_name']))

        if _params.get('spec_packages') is not None:  # noqa: E501
            _query_params.append(('spec.packages', _params['spec_packages']))
            _collection_formats['spec.packages'] = 'multi'
