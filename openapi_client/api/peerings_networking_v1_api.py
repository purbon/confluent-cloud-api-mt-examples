...
class PeeringsNetworkingV1Api:
    ...
    @validate_arguments
    def create_networking_v1_peering(self, create_networking_v1_peering_request : Optional[CreateNetworkingV1PeeringRequest] = None, **kwargs) -> CreateNetworkingV1Peering202Response:  # noqa: E501
        """Create a Peering  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a peering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_networking_v1_peering(create_networking_v1_peering_request, async_req=True)
        >>> result = thread.get()

        :param create_networking_v1_peering_request:
        :type create_networking_v1_peering_request: CreateNetworkingV1PeeringRequest
        ...
        :rtype: CreateNetworkingV1Peering202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_networking_v1_peering_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_networking_v1_peering_with_http_info(create_networking_v1_peering_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_networking_v1_peering_with_http_info(self, create_networking_v1_peering_request : Optional[CreateNetworkingV1PeeringRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Peering  # noqa: E501
        ...
        >>> thread = api.create_networking_v1_peering_with_http_info(create_networking_v1_peering_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNetworkingV1Peering202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_networking_v1_peering_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_networking_v1_peering" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_networking_v1_peering_request'] is not None:
            _body_params = _params['create_networking_v1_peering_request']
        ...
        _response_types_map = {
            '202': "CreateNetworkingV1Peering202Response",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
    ...
    @validate_arguments
    def delete_networking_v1_peering(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], **kwargs) -> None:  # noqa: E501
        """Delete a Peering  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a peering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_networking_v1_peering(environment, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param id: The unique identifier for the peering. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_networking_v1_peering_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_networking_v1_peering_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_networking_v1_peering_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Peering  # noqa: E501
        ...
        >>> thread = api.delete_networking_v1_peering_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_networking_v1_peering" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/networking/v1/peerings/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_networking_v1_peering(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], **kwargs) -> GetNetworkingV1Peering200Response:  # noqa: E501
        """Read a Peering  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a peering.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_peering(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNetworkingV1Peering200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_peering_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_peering_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_peering_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Peering  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_peering_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1Peering200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_networking_v1_peering" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1Peering200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    def list_networking_v1_peerings(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, spec_network : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.network. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1Peerings200Response:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1Peerings200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_peerings_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_peerings_with_http_info(environment, spec_display_name, status_phase, spec_network, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_peerings_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, spec_network : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.network. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Peerings  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_peerings_with_http_info(environment, spec_display_name, status_phase, spec_network, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1Peerings200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_peerings" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListNetworkingV1Peerings200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
    ...
    @validate_arguments
    def update_networking_v1_peering(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], update_networking_v1_peering_request : Optional[UpdateNetworkingV1PeeringRequest] = None, **kwargs) -> GetNetworkingV1Peering200Response:  # noqa: E501
        """Update a Peering  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a peering.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_networking_v1_peering(id, update_networking_v1_peering_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the peering. (required)
        :type id: str
        :param update_networking_v1_peering_request:
        :type update_networking_v1_peering_request: UpdateNetworkingV1PeeringRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_networking_v1_peering_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_networking_v1_peering_with_http_info(id, update_networking_v1_peering_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_networking_v1_peering_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the peering.")], update_networking_v1_peering_request : Optional[UpdateNetworkingV1PeeringRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Peering  # noqa: E501
        ...
        >>> thread = api.update_networking_v1_peering_with_http_info(id, update_networking_v1_peering_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'update_networking_v1_peering_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_networking_v1_peering" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_networking_v1_peering_request'] is not None:
            _body_params = _params['update_networking_v1_peering_request']
        ...
        return self.api_client.call_api(
            '/networking/v1/peerings/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
