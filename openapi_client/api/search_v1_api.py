...
class SearchV1Api:
    ...
    @validate_arguments
    def search_using_attribute(self, type : Annotated[Optional[conlist(StrictStr)], Field(description="Limit the result to only entities of specified types")] = None, attr : Annotated[Optional[conlist(StrictStr)], Field(description="One of more additional attributes to return in the response")] = None, attr_name : Annotated[Optional[conlist(StrictStr)], Field(description="The attribute to search")] = None, attr_value_prefix : Annotated[Optional[conlist(StrictStr)], Field(description="The prefix for the attribute value to search")] = None, tag : Annotated[Optional[StrictStr], Field(description="Limit the result to only entities tagged with the given tag")] = None, sort_by : Annotated[Optional[StrictStr], Field(description="An attribute to sort by")] = None, sort_order : Annotated[Optional[StrictStr], Field(description="Sort order, either ASCENDING (default) or DESCENDING")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted entities")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit the result set to only include the specified number of entries")] = None, offset : Annotated[Optional[StrictInt], Field(description="Start offset of the result set (useful for pagination)")] = None, **kwargs) -> SearchResult:  # noqa: E501
        """Search by Attribute  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve data for the specified attribute search query.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_using_attribute(type, attr, attr_name, attr_value_prefix, tag, sort_by, sort_order, deleted, limit, offset, async_req=True)
        >>> result = thread.get()

        :param type: Limit the result to only entities of specified types
        :type type: List[str]
        :param attr: One of more additional attributes to return in the response
        :type attr: List[str]
        :param attr_name: The attribute to search
        :type attr_name: List[str]
        :param attr_value_prefix: The prefix for the attribute value to search
        :type attr_value_prefix: List[str]
        :param tag: Limit the result to only entities tagged with the given tag
        :type tag: str
        :param sort_by: An attribute to sort by
        :type sort_by: str
        :param sort_order: Sort order, either ASCENDING (default) or DESCENDING
        :type sort_order: str
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the search_using_attribute_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.search_using_attribute_with_http_info(type, attr, attr_name, attr_value_prefix, tag, sort_by, sort_order, deleted, limit, offset, **kwargs)  # noqa: E501

    @validate_arguments
    def search_using_attribute_with_http_info(self, type : Annotated[Optional[conlist(StrictStr)], Field(description="Limit the result to only entities of specified types")] = None, attr : Annotated[Optional[conlist(StrictStr)], Field(description="One of more additional attributes to return in the response")] = None, attr_name : Annotated[Optional[conlist(StrictStr)], Field(description="The attribute to search")] = None, attr_value_prefix : Annotated[Optional[conlist(StrictStr)], Field(description="The prefix for the attribute value to search")] = None, tag : Annotated[Optional[StrictStr], Field(description="Limit the result to only entities tagged with the given tag")] = None, sort_by : Annotated[Optional[StrictStr], Field(description="An attribute to sort by")] = None, sort_order : Annotated[Optional[StrictStr], Field(description="Sort order, either ASCENDING (default) or DESCENDING")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted entities")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit the result set to only include the specified number of entries")] = None, offset : Annotated[Optional[StrictInt], Field(description="Start offset of the result set (useful for pagination)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Search by Attribute  # noqa: E501
        ...
        >>> thread = api.search_using_attribute_with_http_info(type, attr, attr_name, attr_value_prefix, tag, sort_by, sort_order, deleted, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method search_using_attribute" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('attr') is not None:  # noqa: E501
            _query_params.append(('attr', _params['attr']))
            _collection_formats['attr'] = 'multi'

        if _params.get('attr_name') is not None:  # noqa: E501
            _query_params.append(('attrName', _params['attr_name']))
            _collection_formats['attrName'] = 'multi'

        if _params.get('attr_value_prefix') is not None:  # noqa: E501
            _query_params.append(('attrValuePrefix', _params['attr_value_prefix']))
            _collection_formats['attrValuePrefix'] = 'multi'
        ...
        return self.api_client.call_api(
            '/catalog/v1/search/attribute', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def search_using_basic(self, query : Annotated[Optional[StrictStr], Field(description="The full-text query")] = None, type : Annotated[Optional[conlist(StrictStr)], Field(description="Limit the result to only entities of specified types")] = None, attr : Annotated[Optional[conlist(StrictStr)], Field(description="One of more additional attributes to return in the response")] = None, tag : Annotated[Optional[StrictStr], Field(description="Limit the result to only entities tagged with the given tag")] = None, sort_by : Annotated[Optional[StrictStr], Field(description="An attribute to sort by")] = None, sort_order : Annotated[Optional[StrictStr], Field(description="Sort order, either ASCENDING (default) or DESCENDING")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted entities")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit the result set to only include the specified number of entries")] = None, offset : Annotated[Optional[StrictInt], Field(description="Start offset of the result set (useful for pagination)")] = None, **kwargs) -> SearchResult:  # noqa: E501
        """Search by Fulltext Query  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve data for the specified fulltext query.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_using_basic(query, type, attr, tag, sort_by, sort_order, deleted, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the search_using_basic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.search_using_basic_with_http_info(query, type, attr, tag, sort_by, sort_order, deleted, limit, offset, **kwargs)  # noqa: E501

    @validate_arguments
    def search_using_basic_with_http_info(self, query : Annotated[Optional[StrictStr], Field(description="The full-text query")] = None, type : Annotated[Optional[conlist(StrictStr)], Field(description="Limit the result to only entities of specified types")] = None, attr : Annotated[Optional[conlist(StrictStr)], Field(description="One of more additional attributes to return in the response")] = None, tag : Annotated[Optional[StrictStr], Field(description="Limit the result to only entities tagged with the given tag")] = None, sort_by : Annotated[Optional[StrictStr], Field(description="An attribute to sort by")] = None, sort_order : Annotated[Optional[StrictStr], Field(description="Sort order, either ASCENDING (default) or DESCENDING")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted entities")] = None, limit : Annotated[Optional[StrictInt], Field(description="Limit the result set to only include the specified number of entries")] = None, offset : Annotated[Optional[StrictInt], Field(description="Start offset of the result set (useful for pagination)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Search by Fulltext Query  # noqa: E501
        ...
        >>> thread = api.search_using_basic_with_http_info(query, type, attr, tag, sort_by, sort_order, deleted, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_using_basic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
