...
class ScopesServiceQuotaV1Api:
    ...
    @validate_arguments
    def get_service_quota_v1_scope(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the scope.")], **kwargs) -> GetServiceQuotaV1Scope200Response:  # noqa: E501
        """Read a Scope  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a scope.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_service_quota_v1_scope(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the scope. (required)
        :type id: str
        ...
        :rtype: GetServiceQuotaV1Scope200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_service_quota_v1_scope_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_service_quota_v1_scope_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_service_quota_v1_scope_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the scope.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Scope  # noqa: E501
        ...
        >>> thread = api.get_service_quota_v1_scope_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetServiceQuotaV1Scope200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_service_quota_v1_scope" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetServiceQuotaV1Scope200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/service-quota/v1/scopes/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_service_quota_v1_scopes(self, page_size : Annotated[Optional[conint(strict=True, le=200)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ServiceQuotaV1ScopeList:  # noqa: E501
        """List of Scopes  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all scopes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_service_quota_v1_scopes(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ServiceQuotaV1ScopeList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_service_quota_v1_scopes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_service_quota_v1_scopes_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_service_quota_v1_scopes_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=200)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Scopes  # noqa: E501
        ...
        >>> thread = api.list_service_quota_v1_scopes_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ServiceQuotaV1ScopeList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_service_quota_v1_scopes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
