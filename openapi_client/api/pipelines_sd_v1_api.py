...
class PipelinesSdV1Api:
    ...
    @validate_arguments
    def create_sd_v1_pipeline(self, create_sd_v1_pipeline_request : Optional[CreateSdV1PipelineRequest] = None, **kwargs) -> CreateSdV1Pipeline202Response:  # noqa: E501
        """Create a Pipeline  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_sd_v1_pipeline(create_sd_v1_pipeline_request, async_req=True)
        >>> result = thread.get()

        :param create_sd_v1_pipeline_request:
        :type create_sd_v1_pipeline_request: CreateSdV1PipelineRequest
        ...
        :rtype: CreateSdV1Pipeline202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_sd_v1_pipeline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_sd_v1_pipeline_with_http_info(create_sd_v1_pipeline_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_sd_v1_pipeline_with_http_info(self, create_sd_v1_pipeline_request : Optional[CreateSdV1PipelineRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Pipeline  # noqa: E501
        ...
        >>> thread = api.create_sd_v1_pipeline_with_http_info(create_sd_v1_pipeline_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateSdV1Pipeline202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_sd_v1_pipeline_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_sd_v1_pipeline" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_sd_v1_pipeline_request'] is not None:
            _body_params = _params['create_sd_v1_pipeline_request']
        ...
        _response_types_map = {
            '202': "CreateSdV1Pipeline202Response",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
    ...
    @validate_arguments
    def delete_sd_v1_pipeline(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Scope the operation to the given spec.kafka_cluster.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], **kwargs) -> None:  # noqa: E501
        """Delete a Pipeline  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_sd_v1_pipeline(environment, spec_kafka_cluster, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param spec_kafka_cluster: Scope the operation to the given spec.kafka_cluster. (required)
        :type spec_kafka_cluster: str
        :param id: The unique identifier for the pipeline. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_sd_v1_pipeline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_sd_v1_pipeline_with_http_info(environment, spec_kafka_cluster, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_sd_v1_pipeline_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Scope the operation to the given spec.kafka_cluster.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Pipeline  # noqa: E501
        ...
        >>> thread = api.delete_sd_v1_pipeline_with_http_info(environment, spec_kafka_cluster, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_sd_v1_pipeline" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('spec_kafka_cluster') is not None:  # noqa: E501
            _query_params.append(('spec.kafka_cluster', _params['spec_kafka_cluster']))
    ...
    @validate_arguments
    def get_sd_v1_pipeline(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Scope the operation to the given spec.kafka_cluster.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], **kwargs) -> GetSdV1Pipeline200Response:  # noqa: E501
        """Read a Pipeline  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a pipeline.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sd_v1_pipeline(environment, spec_kafka_cluster, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetSdV1Pipeline200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_sd_v1_pipeline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_sd_v1_pipeline_with_http_info(environment, spec_kafka_cluster, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_sd_v1_pipeline_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Scope the operation to the given spec.kafka_cluster.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Pipeline  # noqa: E501
        ...
        >>> thread = api.get_sd_v1_pipeline_with_http_info(environment, spec_kafka_cluster, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetSdV1Pipeline200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sd_v1_pipeline" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetSdV1Pipeline200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_sd_v1_pipelines(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.kafka_cluster.")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListSdV1Pipelines200Response:  # noqa: E501
        """List of Pipelines  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all pipelines.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_sd_v1_pipelines(environment, spec_kafka_cluster, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param environment: Filter the results by exact match for environment. (required)
        :type environment: str
        :param spec_kafka_cluster: Filter the results by exact match for spec.kafka_cluster. (required)
        :type spec_kafka_cluster: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListSdV1Pipelines200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_sd_v1_pipelines_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_sd_v1_pipelines_with_http_info(environment, spec_kafka_cluster, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_sd_v1_pipelines_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_kafka_cluster : Annotated[StrictStr, Field(..., description="Filter the results by exact match for spec.kafka_cluster.")], page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Pipelines  # noqa: E501
        ...
        >>> thread = api.list_sd_v1_pipelines_with_http_info(environment, spec_kafka_cluster, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListSdV1Pipelines200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_sd_v1_pipelines" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListSdV1Pipelines200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
    ...
    @validate_arguments
    def update_sd_v1_pipeline(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], update_sd_v1_pipeline_request : Optional[UpdateSdV1PipelineRequest] = None, **kwargs) -> GetSdV1Pipeline200Response:  # noqa: E501
        """Update a Pipeline  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a pipeline.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_sd_v1_pipeline(id, update_sd_v1_pipeline_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the pipeline. (required)
        :type id: str
        :param update_sd_v1_pipeline_request:
        :type update_sd_v1_pipeline_request: UpdateSdV1PipelineRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_sd_v1_pipeline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_sd_v1_pipeline_with_http_info(id, update_sd_v1_pipeline_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_sd_v1_pipeline_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the pipeline.")], update_sd_v1_pipeline_request : Optional[UpdateSdV1PipelineRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Pipeline  # noqa: E501
        ...
        >>> thread = api.update_sd_v1_pipeline_with_http_info(id, update_sd_v1_pipeline_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_sd_v1_pipeline" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_sd_v1_pipeline_request'] is not None:
            _body_params = _params['update_sd_v1_pipeline_request']
