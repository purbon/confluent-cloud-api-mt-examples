...
class AppliedQuotasServiceQuotaV1Api:
    ...
    @validate_arguments
    def get_service_quota_v1_applied_quota(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the applied quota.")], environment : Annotated[Optional[StrictStr], Field(description="The environment ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"ENVIRONMENT\" or \"NETWORK\" or \"KAFKA_CLUSTER\". ")] = None, network : Annotated[Optional[StrictStr], Field(description="The network ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"NETWORK\". ")] = None, kafka_cluster : Annotated[Optional[StrictStr], Field(description="The kafka cluster ID the quota is associated with. This field is required only when the scope of quota is \"KAFKA_CLUSTER\". ")] = None, **kwargs) -> GetServiceQuotaV1AppliedQuota200Response:  # noqa: E501
        """Read an Applied Quota  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read an applied quota.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_service_quota_v1_applied_quota(id, environment, network, kafka_cluster, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the applied quota. (required)
        :type id: str
        :param environment: The environment ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"ENVIRONMENT\" or \"NETWORK\" or \"KAFKA_CLUSTER\". 
        :type environment: str
        :param network: The network ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"NETWORK\". 
        :type network: str
        :param kafka_cluster: The kafka cluster ID the quota is associated with. This field is required only when the scope of quota is \"KAFKA_CLUSTER\". 
        :type kafka_cluster: str
        ...
        :rtype: GetServiceQuotaV1AppliedQuota200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_service_quota_v1_applied_quota_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_service_quota_v1_applied_quota_with_http_info(id, environment, network, kafka_cluster, **kwargs)  # noqa: E501

    @validate_arguments
    def get_service_quota_v1_applied_quota_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the applied quota.")], environment : Annotated[Optional[StrictStr], Field(description="The environment ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"ENVIRONMENT\" or \"NETWORK\" or \"KAFKA_CLUSTER\". ")] = None, network : Annotated[Optional[StrictStr], Field(description="The network ID the quota is associated with. This field is only required when retrieving a single quota and the scope of quota is \"NETWORK\". ")] = None, kafka_cluster : Annotated[Optional[StrictStr], Field(description="The kafka cluster ID the quota is associated with. This field is required only when the scope of quota is \"KAFKA_CLUSTER\". ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Applied Quota  # noqa: E501
        ...
        >>> thread = api.get_service_quota_v1_applied_quota_with_http_info(id, environment, network, kafka_cluster, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetServiceQuotaV1AppliedQuota200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_service_quota_v1_applied_quota" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('kafka_cluster') is not None:  # noqa: E501
            _query_params.append(('kafka_cluster', _params['kafka_cluster']))
        ...
        _response_types_map = {
            '200': "GetServiceQuotaV1AppliedQuota200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/service-quota/v1/applied-quotas/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_service_quota_v1_applied_quotas(self, scope : Annotated[StrictStr, Field(..., description="The applied scope the quota belongs to. ")], environment : Annotated[Optional[StrictStr], Field(description="The environment ID the quota is associated with. ")] = None, network : Annotated[Optional[StrictStr], Field(description="The network ID the quota is associated with. ")] = None, kafka_cluster : Annotated[Optional[StrictStr], Field(description="The kafka cluster ID the quota is associated with. ")] = None, id : Annotated[Optional[StrictStr], Field(description="The id (quota code) that this quota belongs to. ")] = None, page_size : Annotated[Optional[conint(strict=True, le=200)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListServiceQuotaV1AppliedQuotas200Response:  # noqa: E501
        """List of Applied Quotas  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all applied quotas.  Shows all quotas for a given scope.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_service_quota_v1_applied_quotas(scope, environment, network, kafka_cluster, id, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param scope: The applied scope the quota belongs to.  (required)
        :type scope: str
        :param environment: The environment ID the quota is associated with. 
        :type environment: str
        :param network: The network ID the quota is associated with. 
        :type network: str
        :param kafka_cluster: The kafka cluster ID the quota is associated with. 
        :type kafka_cluster: str
        :param id: The id (quota code) that this quota belongs to. 
        :type id: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListServiceQuotaV1AppliedQuotas200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_service_quota_v1_applied_quotas_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_service_quota_v1_applied_quotas_with_http_info(scope, environment, network, kafka_cluster, id, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_service_quota_v1_applied_quotas_with_http_info(self, scope : Annotated[StrictStr, Field(..., description="The applied scope the quota belongs to. ")], environment : Annotated[Optional[StrictStr], Field(description="The environment ID the quota is associated with. ")] = None, network : Annotated[Optional[StrictStr], Field(description="The network ID the quota is associated with. ")] = None, kafka_cluster : Annotated[Optional[StrictStr], Field(description="The kafka cluster ID the quota is associated with. ")] = None, id : Annotated[Optional[StrictStr], Field(description="The id (quota code) that this quota belongs to. ")] = None, page_size : Annotated[Optional[conint(strict=True, le=200)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Applied Quotas  # noqa: E501
        ...
        >>> thread = api.list_service_quota_v1_applied_quotas_with_http_info(scope, environment, network, kafka_cluster, id, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListServiceQuotaV1AppliedQuotas200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_service_quota_v1_applied_quotas" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListServiceQuotaV1AppliedQuotas200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/service-quota/v1/applied-quotas', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
