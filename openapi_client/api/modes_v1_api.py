...
class ModesV1Api:
    ...
    @validate_arguments
    def delete_subject_mode(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], **kwargs) -> Mode:  # noqa: E501
        """Delete subject mode  # noqa: E501

        Deletes the specified subject-level mode and reverts to the global default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_subject_mode(subject, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_subject_mode_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_subject_mode_with_http_info(subject, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_subject_mode_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete subject mode  # noqa: E501
        ...
        >>> thread = api.delete_subject_mode_with_http_info(subject, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Mode, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method delete_subject_mode" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_mode(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], default_to_global : Annotated[Optional[StrictBool], Field(description="Whether to return the global mode if subject mode not found")] = None, **kwargs) -> Mode:  # noqa: E501
        """Get subject mode  # noqa: E501

        Retrieves the subject mode.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_mode(subject, default_to_global, async_req=True)
        >>> result = thread.get()

        :param subject: Name of the subject (required)
        :type subject: str
        :param default_to_global: Whether to return the global mode if subject mode not found
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_mode_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_mode_with_http_info(subject, default_to_global, **kwargs)  # noqa: E501

    @validate_arguments
    def get_mode_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], default_to_global : Annotated[Optional[StrictBool], Field(description="Whether to return the global mode if subject mode not found")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get subject mode  # noqa: E501
        ...
        >>> thread = api.get_mode_with_http_info(subject, default_to_global, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_top_level_mode(self, **kwargs) -> Mode:  # noqa: E501
        """Get global mode  # noqa: E501

        Retrieves global mode.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_top_level_mode(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_top_level_mode_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_top_level_mode_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_top_level_mode_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get global mode  # noqa: E501
        ...
        >>> thread = api.get_top_level_mode_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_top_level_mode" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_mode(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], mode_update_request : Annotated[ModeUpdateRequest, Field(..., description="Update Request")], force : Annotated[Optional[StrictBool], Field(description="Whether to force update if setting mode to IMPORT and schemas currently exist")] = None, **kwargs) -> ModeUpdateRequest:  # noqa: E501
        """Update subject mode  # noqa: E501

        Update mode for the specified subject. On success, echoes the original request back to the client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_mode(subject, mode_update_request, force, async_req=True)
        >>> result = thread.get()

        :param subject: Name of the subject (required)
        :type subject: str
        :param mode_update_request: Update Request (required)
        :type mode_update_request: ModeUpdateRequest
        :param force: Whether to force update if setting mode to IMPORT and schemas currently exist
        :type force: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ModeUpdateRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_mode_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_mode_with_http_info(subject, mode_update_request, force, **kwargs)  # noqa: E501

    @validate_arguments
    def update_mode_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], mode_update_request : Annotated[ModeUpdateRequest, Field(..., description="Update Request")], force : Annotated[Optional[StrictBool], Field(description="Whether to force update if setting mode to IMPORT and schemas currently exist")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update subject mode  # noqa: E501
        ...
        >>> thread = api.update_mode_with_http_info(subject, mode_update_request, force, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ModeUpdateRequest, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # process the body parameter
        _body_params = None
        if _params['mode_update_request'] is not None:
            _body_params = _params['mode_update_request']
    ...
    @validate_arguments
    def update_top_level_mode(self, mode_update_request : Annotated[ModeUpdateRequest, Field(..., description="Update Request")], force : Annotated[Optional[StrictBool], Field(description="Whether to force update if setting mode to IMPORT and schemas currently exist")] = None, **kwargs) -> ModeUpdateRequest:  # noqa: E501
        """Update global mode  # noqa: E501

        Update global mode. On success, echoes the original request back to the client.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_top_level_mode(mode_update_request, force, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_top_level_mode_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_top_level_mode_with_http_info(mode_update_request, force, **kwargs)  # noqa: E501

    @validate_arguments
    def update_top_level_mode_with_http_info(self, mode_update_request : Annotated[ModeUpdateRequest, Field(..., description="Update Request")], force : Annotated[Optional[StrictBool], Field(description="Whether to force update if setting mode to IMPORT and schemas currently exist")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update global mode  # noqa: E501
        ...
        >>> thread = api.update_top_level_mode_with_http_info(mode_update_request, force, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_top_level_mode" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
