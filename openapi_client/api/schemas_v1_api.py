...
class SchemasV1Api:
    ...
    @validate_arguments
    def get_schema(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Name of the subject")] = None, format : Annotated[Optional[StrictStr], Field(description="Desired output format, dependent on schema type")] = None, fetch_max_id : Annotated[Optional[StrictBool], Field(description="Whether to fetch the maximum schema identifier that exists")] = None, **kwargs) -> SchemaString:  # noqa: E501
        """Get schema string by ID  # noqa: E501

        Retrieves the schema string identified by the input ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schema(id, subject, format, fetch_max_id, async_req=True)
        >>> result = thread.get()

        :param id: Globally unique identifier of the schema (required)
        :type id: int
        :param subject: Name of the subject
        :type subject: str
        :param format: Desired output format, dependent on schema type
        :type format: str
        :param fetch_max_id: Whether to fetch the maximum schema identifier that exists
        :type fetch_max_id: bool
        ...
        return self.get_schema_with_http_info(id, subject, format, fetch_max_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_schema_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Name of the subject")] = None, format : Annotated[Optional[StrictStr], Field(description="Desired output format, dependent on schema type")] = None, fetch_max_id : Annotated[Optional[StrictBool], Field(description="Whether to fetch the maximum schema identifier that exists")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get schema string by ID  # noqa: E501
        ...
        >>> thread = api.get_schema_with_http_info(id, subject, format, fetch_max_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SchemaString, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if _params.get('fetch_max_id') is not None:  # noqa: E501
            _query_params.append(('fetchMaxId', _params['fetch_max_id']))
    ...
    @validate_arguments
    def get_schema_only(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Name of the subject")] = None, format : Annotated[Optional[StrictStr], Field(description="Desired output format, dependent on schema type")] = None, **kwargs) -> str:  # noqa: E501
        """Get schema by ID  # noqa: E501

        Retrieves the schema identified by the input ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schema_only(id, subject, format, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_schema_only_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_schema_only_with_http_info(id, subject, format, **kwargs)  # noqa: E501

    @validate_arguments
    def get_schema_only_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Name of the subject")] = None, format : Annotated[Optional[StrictStr], Field(description="Desired output format, dependent on schema type")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get schema by ID  # noqa: E501
        ...
        >>> thread = api.get_schema_only_with_http_info(id, subject, format, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_schema_only" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_schema_types(self, **kwargs) -> List[str]:  # noqa: E501
        """List supported schema types  # noqa: E501

        Retrieve the schema types supported by this registry.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schema_types(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_schema_types_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_schema_types_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_schema_types_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List supported schema types  # noqa: E501
        ...
        >>> thread = api.get_schema_types_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_schema_types" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_schemas(self, subject_prefix : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject prefix")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to return soft deleted schemas")] = None, latest_only : Annotated[Optional[StrictBool], Field(description="Whether to return latest schema versions only for each matching subject")] = None, offset : Annotated[Optional[StrictInt], Field(description="Pagination offset for results")] = None, limit : Annotated[Optional[StrictInt], Field(description="Pagination size for results. Ignored if negative")] = None, **kwargs) -> List[ModelSchema]:  # noqa: E501
        """List schemas  # noqa: E501

        Get the schemas matching the specified parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schemas(subject_prefix, deleted, latest_only, offset, limit, async_req=True)
        >>> result = thread.get()

        :param subject_prefix: Filters results by the respective subject prefix
        :type subject_prefix: str
        :param deleted: Whether to return soft deleted schemas
        :type deleted: bool
        :param latest_only: Whether to return latest schema versions only for each matching subject
        :type latest_only: bool
        :param offset: Pagination offset for results
        :type offset: int
        :param limit: Pagination size for results. Ignored if negative
        :type limit: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_schemas_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_schemas_with_http_info(subject_prefix, deleted, latest_only, offset, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def get_schemas_with_http_info(self, subject_prefix : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject prefix")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to return soft deleted schemas")] = None, latest_only : Annotated[Optional[StrictBool], Field(description="Whether to return latest schema versions only for each matching subject")] = None, offset : Annotated[Optional[StrictInt], Field(description="Pagination offset for results")] = None, limit : Annotated[Optional[StrictInt], Field(description="Pagination size for results. Ignored if negative")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List schemas  # noqa: E501
        ...
        >>> thread = api.get_schemas_with_http_info(subject_prefix, deleted, latest_only, offset, limit, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_subjects(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include subjects where the schema was deleted")] = None, **kwargs) -> List[str]:  # noqa: E501
        """List subjects associated to schema ID  # noqa: E501

        Retrieves all the subjects associated with a particular schema ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_subjects(id, subject, deleted, async_req=True)
        >>> result = thread.get()

        :param id: Globally unique identifier of the schema (required)
        :type id: int
        :param subject: Filters results by the respective subject
        :type subject: str
        :param deleted: Whether to include subjects where the schema was deleted
        :type deleted: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_subjects_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_subjects_with_http_info(id, subject, deleted, **kwargs)  # noqa: E501
    ...
    def get_subjects_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include subjects where the schema was deleted")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_subjects_with_http_info(id, subject, deleted, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_versions(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include subject versions where the schema was deleted")] = None, **kwargs) -> List[SubjectVersion]:  # noqa: E501
        """List subject-versions associated to schema ID  # noqa: E501

        Get all the subject-version pairs associated with the input ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_versions(id, subject, deleted, async_req=True)
        >>> result = thread.get()
        ...
        :param subject: Filters results by the respective subject
        :type subject: str
        :param deleted: Whether to include subject versions where the schema was deleted
        :type deleted: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_versions_with_http_info(id, subject, deleted, **kwargs)  # noqa: E501
    ...
    def get_versions_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Globally unique identifier of the schema")], subject : Annotated[Optional[StrictStr], Field(description="Filters results by the respective subject")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to include subject versions where the schema was deleted")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_versions_with_http_info(id, subject, deleted, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[SubjectVersion], status_code(int), headers(HTTPHeaderDict))
        """
