...
class GroupMappingsIamV2SsoApi:
    ...
    @validate_arguments
    def create_iam_v2_sso_group_mapping(self, create_iam_v2_sso_group_mapping_request : Optional[CreateIamV2SsoGroupMappingRequest] = None, **kwargs) -> CreateIamV2SsoGroupMappingRequest:  # noqa: E501
        """Create a Group Mapping  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Group Mapping CRUD API](https://img.shields.io/badge/-Request%20Access%20To%20Group%20Mapping%20CRUD%20API-%23bc8540)](mailto:ccloud-api-access+iam/v2-sso-early-access@confluent.io?subject=Request%20to%20join%20SSO%20Identity%20Pool%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2/sso%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to create a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_sso_group_mapping(create_iam_v2_sso_group_mapping_request, async_req=True)
        >>> result = thread.get()

        :param create_iam_v2_sso_group_mapping_request:
        :type create_iam_v2_sso_group_mapping_request: CreateIamV2SsoGroupMappingRequest
        ...
        :rtype: CreateIamV2SsoGroupMappingRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_iam_v2_sso_group_mapping_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_iam_v2_sso_group_mapping_with_http_info(create_iam_v2_sso_group_mapping_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_iam_v2_sso_group_mapping_with_http_info(self, create_iam_v2_sso_group_mapping_request : Optional[CreateIamV2SsoGroupMappingRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Group Mapping  # noqa: E501
        ...
        >>> thread = api.create_iam_v2_sso_group_mapping_with_http_info(create_iam_v2_sso_group_mapping_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateIamV2SsoGroupMappingRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_iam_v2_sso_group_mapping_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_iam_v2_sso_group_mapping" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_iam_v2_sso_group_mapping_request'] is not None:
            _body_params = _params['create_iam_v2_sso_group_mapping_request']
        ...
        _response_types_map = {
            '201': "CreateIamV2SsoGroupMappingRequest",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/sso/group-mappings', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_iam_v2_sso_group_mapping(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], **kwargs) -> None:  # noqa: E501
        """Delete a Group Mapping  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Group Mapping CRUD API](https://img.shields.io/badge/-Request%20Access%20To%20Group%20Mapping%20CRUD%20API-%23bc8540)](mailto:ccloud-api-access+iam/v2-sso-early-access@confluent.io?subject=Request%20to%20join%20SSO%20Identity%20Pool%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2/sso%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to delete a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_iam_v2_sso_group_mapping(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the group mapping. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_iam_v2_sso_group_mapping_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_iam_v2_sso_group_mapping_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_iam_v2_sso_group_mapping_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Group Mapping  # noqa: E501
        ...
        >>> thread = api.delete_iam_v2_sso_group_mapping_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_iam_v2_sso_group_mapping" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/iam/v2/sso/group-mappings/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_iam_v2_sso_group_mapping(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], **kwargs) -> GetIamV2SsoGroupMapping200Response:  # noqa: E501
        """Read a Group Mapping  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Group Mapping CRUD API](https://img.shields.io/badge/-Request%20Access%20To%20Group%20Mapping%20CRUD%20API-%23bc8540)](mailto:ccloud-api-access+iam/v2-sso-early-access@confluent.io?subject=Request%20to%20join%20SSO%20Identity%20Pool%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2/sso%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to read a group mapping.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_iam_v2_sso_group_mapping(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetIamV2SsoGroupMapping200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_iam_v2_sso_group_mapping_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_iam_v2_sso_group_mapping_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_iam_v2_sso_group_mapping_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Group Mapping  # noqa: E501
        ...
        >>> thread = api.get_iam_v2_sso_group_mapping_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetIamV2SsoGroupMapping200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_iam_v2_sso_group_mapping" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetIamV2SsoGroupMapping200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/sso/group-mappings/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_iam_v2_sso_group_mappings(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> IamV2SsoGroupMappingList:  # noqa: E501
        """List of Group Mappings  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Group Mapping CRUD API](https://img.shields.io/badge/-Request%20Access%20To%20Group%20Mapping%20CRUD%20API-%23bc8540)](mailto:ccloud-api-access+iam/v2-sso-early-access@confluent.io?subject=Request%20to%20join%20SSO%20Identity%20Pool%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2/sso%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Retrieve a sorted, filtered, paginated list of all group mappings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_sso_group_mappings(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IamV2SsoGroupMappingList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_iam_v2_sso_group_mappings_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_iam_v2_sso_group_mappings_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_iam_v2_sso_group_mappings_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Group Mappings  # noqa: E501
        ...
        >>> thread = api.list_iam_v2_sso_group_mappings_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IamV2SsoGroupMappingList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_iam_v2_sso_group_mappings" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_iam_v2_sso_group_mapping(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], iam_v2_sso_group_mapping : Optional[IamV2SsoGroupMapping] = None, **kwargs) -> GetIamV2SsoGroupMapping200Response:  # noqa: E501
        """Update a Group Mapping  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Group Mapping CRUD API](https://img.shields.io/badge/-Request%20Access%20To%20Group%20Mapping%20CRUD%20API-%23bc8540)](mailto:ccloud-api-access+iam/v2-sso-early-access@confluent.io?subject=Request%20to%20join%20SSO%20Identity%20Pool%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2/sso%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to update a group mapping.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_iam_v2_sso_group_mapping(id, iam_v2_sso_group_mapping, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the group mapping. (required)
        :type id: str
        :param iam_v2_sso_group_mapping:
        :type iam_v2_sso_group_mapping: IamV2SsoGroupMapping
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_iam_v2_sso_group_mapping_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_iam_v2_sso_group_mapping_with_http_info(id, iam_v2_sso_group_mapping, **kwargs)  # noqa: E501

    @validate_arguments
    def update_iam_v2_sso_group_mapping_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the group mapping.")], iam_v2_sso_group_mapping : Optional[IamV2SsoGroupMapping] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Group Mapping  # noqa: E501
        ...
        >>> thread = api.update_iam_v2_sso_group_mapping_with_http_info(id, iam_v2_sso_group_mapping, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_iam_v2_sso_group_mapping" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['iam_v2_sso_group_mapping'] is not None:
            _body_params = _params['iam_v2_sso_group_mapping']
        ...
        return self.api_client.call_api(
            '/iam/v2/sso/group-mappings/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
