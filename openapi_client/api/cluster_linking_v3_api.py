...
class ClusterLinkingV3Api:
    ...
    @validate_arguments
    def create_kafka_link(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, validate_link : Annotated[Optional[StrictBool], Field(description="To synchronously validate that the source cluster ID is expected and the dest cluster has the permission to read topics in the source cluster. Default: true")] = None, create_link_request_data : Annotated[Optional[CreateLinkRequestData], Field(description="Create a cluster link")] = None, **kwargs) -> None:  # noqa: E501
        """Create a cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_kafka_link(cluster_id, link_name, validate_only, validate_link, create_link_request_data, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param link_name: The link name (required)
        :type link_name: str
        :param validate_only: To validate the action can be performed successfully or not. Default: false
        :type validate_only: bool
        :param validate_link: To synchronously validate that the source cluster ID is expected and the dest cluster has the permission to read topics in the source cluster. Default: true
        :type validate_link: bool
        :param create_link_request_data: Create a cluster link
        :type create_link_request_data: CreateLinkRequestData
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_kafka_link_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_kafka_link_with_http_info(cluster_id, link_name, validate_only, validate_link, create_link_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def create_kafka_link_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, validate_link : Annotated[Optional[StrictBool], Field(description="To synchronously validate that the source cluster ID is expected and the dest cluster has the permission to read topics in the source cluster. Default: true")] = None, create_link_request_data : Annotated[Optional[CreateLinkRequestData], Field(description="Create a cluster link")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a cluster link  # noqa: E501
        ...
        >>> thread = api.create_kafka_link_with_http_info(cluster_id, link_name, validate_only, validate_link, create_link_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method create_kafka_link" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('link_name') is not None:  # noqa: E501
            _query_params.append(('link_name', _params['link_name']))

        if _params.get('validate_only') is not None:  # noqa: E501
            _query_params.append(('validate_only', _params['validate_only']))

        if _params.get('validate_link') is not None:  # noqa: E501
            _query_params.append(('validate_link', _params['validate_link']))
        ...
        _body_params = None
        if _params['create_link_request_data'] is not None:
            _body_params = _params['create_link_request_data']
        ...
        _auth_settings = ['external-access-token', 'resource-api-key']  # noqa: E501

        _response_types_map = {}

        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_kafka_mirror_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], create_mirror_topic_request_data : Annotated[Optional[CreateMirrorTopicRequestData], Field(description="Name and configs of the topics mirroring from and mirroring to. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).")] = None, **kwargs) -> None:  # noqa: E501
        """Create a mirror topic  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Create a topic in the destination cluster mirroring a topic in the source cluster  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_kafka_mirror_topic(cluster_id, link_name, create_mirror_topic_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :param link_name: The link name (required)
        :type link_name: str
        :param create_mirror_topic_request_data: Name and configs of the topics mirroring from and mirroring to. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).
        :type create_mirror_topic_request_data: CreateMirrorTopicRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_kafka_mirror_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_kafka_mirror_topic_with_http_info(cluster_id, link_name, create_mirror_topic_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def create_kafka_mirror_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], create_mirror_topic_request_data : Annotated[Optional[CreateMirrorTopicRequestData], Field(description="Name and configs of the topics mirroring from and mirroring to. Note that Confluent Cloud allows only specific replication factor values. Because of that the replication factor field should either be omitted or it should use one of the allowed values (see https://docs.confluent.io/cloud/current/client-apps/optimizing/durability.html).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a mirror topic  # noqa: E501
        ...
        >>> thread = api.create_kafka_mirror_topic_with_http_info(cluster_id, link_name, create_mirror_topic_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_kafka_mirror_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['link_name']:
            _path_params['link_name'] = _params['link_name']
        ...
        # process the body parameter
        _body_params = None
        if _params['create_mirror_topic_request_data'] is not None:
            _body_params = _params['create_mirror_topic_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_kafka_link(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], force : Annotated[Optional[StrictBool], Field(description="Force the action. Default: false")] = None, validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, **kwargs) -> None:  # noqa: E501
        """Delete the cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_kafka_link(cluster_id, link_name, force, validate_only, async_req=True)
        >>> result = thread.get()
        ...
        :param link_name: The link name (required)
        :type link_name: str
        :param force: Force the action. Default: false
        :type force: bool
        :param validate_only: To validate the action can be performed successfully or not. Default: false
        :type validate_only: bool
        :param async_req: Whether to execute the request asynchronously.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_kafka_link_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_kafka_link_with_http_info(cluster_id, link_name, force, validate_only, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_kafka_link_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], force : Annotated[Optional[StrictBool], Field(description="Force the action. Default: false")] = None, validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete the cluster link  # noqa: E501
        ...
        >>> thread = api.delete_kafka_link_with_http_info(cluster_id, link_name, force, validate_only, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_kafka_link" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_kafka_link_config(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], **kwargs) -> None:  # noqa: E501
        """Reset the given config to default value  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_kafka_link_config(cluster_id, link_name, config_name, async_req=True)
        >>> result = thread.get()
        ...
        :param link_name: The link name (required)
        :type link_name: str
        :param config_name: The link config name (required)
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_kafka_link_config_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_kafka_link_config_with_http_info(cluster_id, link_name, config_name, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_kafka_link_config_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Reset the given config to default value  # noqa: E501
        ...
        >>> thread = api.delete_kafka_link_config_with_http_info(cluster_id, link_name, config_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_kafka_link_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['config_name']:
            _path_params['config_name'] = _params['config_name']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_kafka_link(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], **kwargs) -> ListLinksResponseData:  # noqa: E501
        """Describe the cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  ``link_id`` in ``ListLinksResponseData`` is deprecated and may be removed in a future release. Use the new ``cluster_link_id`` instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_kafka_link(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListLinksResponseData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_kafka_link_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_kafka_link_with_http_info(cluster_id, link_name, **kwargs)  # noqa: E501

    @validate_arguments
    def get_kafka_link_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Describe the cluster link  # noqa: E501
        ...
        >>> thread = api.get_kafka_link_with_http_info(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListLinksResponseData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_kafka_link_configs(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], **kwargs) -> ListLinkConfigsResponseData:  # noqa: E501
        """Describe the config under the cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_kafka_link_configs(cluster_id, link_name, config_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListLinkConfigsResponseData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_kafka_link_configs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_kafka_link_configs_with_http_info(cluster_id, link_name, config_name, **kwargs)  # noqa: E501

    @validate_arguments
    def get_kafka_link_configs_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Describe the config under the cluster link  # noqa: E501
        ...
        >>> thread = api.get_kafka_link_configs_with_http_info(cluster_id, link_name, config_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListLinkConfigsResponseData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_kafka_link_configs" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListLinkConfigsResponseData",
            '400': "Error",
            '401': "Error",
            '429': "str",
            '5XX': "Error",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_link_configs(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], **kwargs) -> ListLinkConfigsResponseDataList:  # noqa: E501
        """List all configs of the cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_link_configs(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListLinkConfigsResponseDataList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_link_configs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_link_configs_with_http_info(cluster_id, link_name, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_link_configs_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], **kwargs) -> ApiResponse:  # noqa: E501
        """List all configs of the cluster link  # noqa: E501
        ...
        >>> thread = api.list_kafka_link_configs_with_http_info(cluster_id, link_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListLinkConfigsResponseDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_link_configs" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListLinkConfigsResponseDataList",
            '400': "Error",
            '401': "Error",
            '429': "str",
            '5XX': "Error",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_links(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], **kwargs) -> ListLinksResponseDataList:  # noqa: E501
        """List all cluster links in the dest cluster  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  ``link_id`` in ``ListLinksResponseData`` is deprecated and may be removed in a future release. Use the new ``cluster_link_id`` instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_links(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListLinksResponseDataList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_links_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_links_with_http_info(cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_links_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List all cluster links in the dest cluster  # noqa: E501
        ...
        >>> thread = api.list_kafka_links_with_http_info(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListLinksResponseDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_links" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_mirror_topics(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], mirror_status : Annotated[Optional[MirrorTopicStatus], Field(description="The status of the mirror topic. If not specified, all mirror topics will be returned.")] = None, **kwargs) -> ListMirrorTopicsResponseDataList:  # noqa: E501
        """List mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  List all mirror topics in the cluster  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_mirror_topics(cluster_id, mirror_status, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param mirror_status: The status of the mirror topic. If not specified, all mirror topics will be returned.
        :type mirror_status: MirrorTopicStatus
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListMirrorTopicsResponseDataList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_mirror_topics_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_mirror_topics_with_http_info(cluster_id, mirror_status, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_mirror_topics_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], mirror_status : Annotated[Optional[MirrorTopicStatus], Field(description="The status of the mirror topic. If not specified, all mirror topics will be returned.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List mirror topics  # noqa: E501
        ...
        >>> thread = api.list_kafka_mirror_topics_with_http_info(cluster_id, mirror_status, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListMirrorTopicsResponseDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_mirror_topics" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('mirror_status') is not None:  # noqa: E501
            _query_params.append(('mirror_status', _params['mirror_status'].value))
        ...
        _response_types_map = {
            '200': "ListMirrorTopicsResponseDataList",
            '400': "Error",
            '401': "Error",
            '429': "str",
            '5XX': "Error",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/-/mirrors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_mirror_topics_under_link(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], mirror_status : Annotated[Optional[MirrorTopicStatus], Field(description="The status of the mirror topic. If not specified, all mirror topics will be returned.")] = None, **kwargs) -> ListMirrorTopicsResponseDataList:  # noqa: E501
        """List mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  List all mirror topics under the link  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_mirror_topics_under_link(cluster_id, link_name, mirror_status, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_mirror_topics_under_link_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_mirror_topics_under_link_with_http_info(cluster_id, link_name, mirror_status, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_mirror_topics_under_link_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], mirror_status : Annotated[Optional[MirrorTopicStatus], Field(description="The status of the mirror topic. If not specified, all mirror topics will be returned.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List mirror topics  # noqa: E501
        ...
        >>> thread = api.list_kafka_mirror_topics_under_link_with_http_info(cluster_id, link_name, mirror_status, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_mirror_topics_under_link" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def read_kafka_mirror_topic(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], mirror_topic_name : Annotated[StrictStr, Field(..., description="Cluster Linking mirror topic name")], **kwargs) -> ListMirrorTopicsResponseData:  # noqa: E501
        """Describe the mirror topic  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.read_kafka_mirror_topic(cluster_id, link_name, mirror_topic_name, async_req=True)
        >>> result = thread.get()
        ...
        :param link_name: The link name (required)
        :type link_name: str
        :param mirror_topic_name: Cluster Linking mirror topic name (required)
        :type mirror_topic_name: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListMirrorTopicsResponseData
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_kafka_mirror_topic_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_kafka_mirror_topic_with_http_info(cluster_id, link_name, mirror_topic_name, **kwargs)  # noqa: E501

    @validate_arguments
    def read_kafka_mirror_topic_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], mirror_topic_name : Annotated[StrictStr, Field(..., description="Cluster Linking mirror topic name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Describe the mirror topic  # noqa: E501
        ...
        >>> thread = api.read_kafka_mirror_topic_with_http_info(cluster_id, link_name, mirror_topic_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListMirrorTopicsResponseData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_kafka_mirror_topic" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['mirror_topic_name']:
            _path_params['mirror_topic_name'] = _params['mirror_topic_name']
        ...
        _response_types_map = {
            '200': "ListMirrorTopicsResponseData",
            '400': "Error",
            '401': "Error",
            '429': "str",
            '5XX': "Error",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors/{mirror_topic_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_link_config(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], update_link_config_request_data : Annotated[Optional[UpdateLinkConfigRequestData], Field(description="Link config value to update")] = None, **kwargs) -> None:  # noqa: E501
        """Alter the config under the cluster link  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_link_config(cluster_id, link_name, config_name, update_link_config_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :param config_name: The link config name (required)
        :type config_name: str
        :param update_link_config_request_data: Link config value to update
        :type update_link_config_request_data: UpdateLinkConfigRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_link_config_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_link_config_with_http_info(cluster_id, link_name, config_name, update_link_config_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_link_config_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], config_name : Annotated[StrictStr, Field(..., description="The link config name")], update_link_config_request_data : Annotated[Optional[UpdateLinkConfigRequestData], Field(description="Link config value to update")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Alter the config under the cluster link  # noqa: E501
        ...
        >>> thread = api.update_kafka_link_config_with_http_info(cluster_id, link_name, config_name, update_link_config_request_data, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            ...
            'link_name',
            'config_name',
            'update_link_config_request_data'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_link_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_link_config_request_data'] is not None:
            _body_params = _params['update_link_config_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs/{config_name}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_link_config_batch(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_config_batch_request_data : Optional[AlterConfigBatchRequestData] = None, **kwargs) -> None:  # noqa: E501
        """Batch Alter Cluster Link Configs  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Batch Alter Cluster Link Configs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_link_config_batch(cluster_id, link_name, validate_only, alter_config_batch_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :param validate_only: To validate the action can be performed successfully or not. Default: false
        :type validate_only: bool
        :param alter_config_batch_request_data:
        :type alter_config_batch_request_data: AlterConfigBatchRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_link_config_batch_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_link_config_batch_with_http_info(cluster_id, link_name, validate_only, alter_config_batch_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_link_config_batch_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_config_batch_request_data : Optional[AlterConfigBatchRequestData] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Batch Alter Cluster Link Configs  # noqa: E501
        ...
        >>> thread = api.update_kafka_link_config_batch_with_http_info(cluster_id, link_name, validate_only, alter_config_batch_request_data, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            ...
            'link_name',
            'validate_only',
            'alter_config_batch_request_data'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_link_config_batch" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['alter_config_batch_request_data'] is not None:
            _body_params = _params['alter_config_batch_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/configs:alter', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_mirror_topics_failover(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> AlterMirrorStatusResponseDataList:  # noqa: E501
        """Failover the mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_mirror_topics_failover(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :param validate_only: To validate the action can be performed successfully or not. Default: false
        :type validate_only: bool
        :param alter_mirrors_request_data: Mirror topics to be altered.
        :type alter_mirrors_request_data: AlterMirrorsRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: AlterMirrorStatusResponseDataList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_mirror_topics_failover_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_mirror_topics_failover_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_mirror_topics_failover_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Failover the mirror topics  # noqa: E501
        ...
        >>> thread = api.update_kafka_mirror_topics_failover_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AlterMirrorStatusResponseDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_mirror_topics_failover" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['alter_mirrors_request_data'] is not None:
            _body_params = _params['alter_mirrors_request_data']
        ...
        _response_types_map = {
            '200': "AlterMirrorStatusResponseDataList",
            '400': "Error",
            '401': "Error",
            '429': "str",
            '5XX': "Error",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:failover', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_mirror_topics_pause(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> AlterMirrorStatusResponseDataList:  # noqa: E501
        """Pause the mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_mirror_topics_pause(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_mirror_topics_pause_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_mirror_topics_pause_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_mirror_topics_pause_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Pause the mirror topics  # noqa: E501
        ...
        >>> thread = api.update_kafka_mirror_topics_pause_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_mirror_topics_pause" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:pause', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_mirror_topics_promote(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> AlterMirrorStatusResponseDataList:  # noqa: E501
        """Promote the mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_mirror_topics_promote(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_mirror_topics_promote_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_mirror_topics_promote_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_mirror_topics_promote_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Promote the mirror topics  # noqa: E501
        ...
        >>> thread = api.update_kafka_mirror_topics_promote_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_mirror_topics_promote" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:promote', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_kafka_mirror_topics_resume(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> AlterMirrorStatusResponseDataList:  # noqa: E501
        """Resume the mirror topics  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_kafka_mirror_topics_resume(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_kafka_mirror_topics_resume_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_kafka_mirror_topics_resume_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def update_kafka_mirror_topics_resume_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], link_name : Annotated[StrictStr, Field(..., description="The link name")], validate_only : Annotated[Optional[StrictBool], Field(description="To validate the action can be performed successfully or not. Default: false")] = None, alter_mirrors_request_data : Annotated[Optional[AlterMirrorsRequestData], Field(description="Mirror topics to be altered.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Resume the mirror topics  # noqa: E501
        ...
        >>> thread = api.update_kafka_mirror_topics_resume_with_http_info(cluster_id, link_name, validate_only, alter_mirrors_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_kafka_mirror_topics_resume" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/links/{link_name}/mirrors:resume', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
