...
class ACLV3Api:
    ...
    @validate_arguments
    def batch_create_kafka_acls(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_acl_request_data_list : Annotated[Optional[CreateAclRequestDataList], Field(description="The batch ACL creation request.")] = None, **kwargs) -> None:  # noqa: E501
        """Batch Create ACLs  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Create ACLs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.batch_create_kafka_acls(cluster_id, create_acl_request_data_list, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param create_acl_request_data_list: The batch ACL creation request.
        :type create_acl_request_data_list: CreateAclRequestDataList
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the batch_create_kafka_acls_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.batch_create_kafka_acls_with_http_info(cluster_id, create_acl_request_data_list, **kwargs)  # noqa: E501

    @validate_arguments
    def batch_create_kafka_acls_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_acl_request_data_list : Annotated[Optional[CreateAclRequestDataList], Field(description="The batch ACL creation request.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Batch Create ACLs  # noqa: E501
        ...
        >>> thread = api.batch_create_kafka_acls_with_http_info(cluster_id, create_acl_request_data_list, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method batch_create_kafka_acls" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_acl_request_data_list'] is not None:
            _body_params = _params['create_acl_request_data_list']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/acls:batch', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_kafka_acls(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_acl_request_data : Annotated[Optional[CreateAclRequestData], Field(description="The ACL creation request.")] = None, **kwargs) -> None:  # noqa: E501
        """Create an ACL  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Create an ACL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_kafka_acls(cluster_id, create_acl_request_data, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param create_acl_request_data: The ACL creation request.
        :type create_acl_request_data: CreateAclRequestData
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_kafka_acls_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_kafka_acls_with_http_info(cluster_id, create_acl_request_data, **kwargs)  # noqa: E501

    @validate_arguments
    def create_kafka_acls_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], create_acl_request_data : Annotated[Optional[CreateAclRequestData], Field(description="The ACL creation request.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an ACL  # noqa: E501
        ...
        >>> thread = api.create_kafka_acls_with_http_info(cluster_id, create_acl_request_data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_kafka_acls" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['create_acl_request_data'] is not None:
            _body_params = _params['create_acl_request_data']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/acls', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_kafka_acls(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], resource_type : Annotated[AclResourceType, Field(..., description="The ACL resource type.")], pattern_type : Annotated[StrictStr, Field(..., description="The ACL pattern type.")], operation : Annotated[StrictStr, Field(..., description="The ACL operation.")], permission : Annotated[StrictStr, Field(..., description="The ACL permission.")], resource_name : Annotated[Optional[StrictStr], Field(description="The ACL resource name.")] = None, principal : Annotated[Optional[StrictStr], Field(description="The ACL principal. This is the Service Account name or user name.")] = None, host : Annotated[Optional[StrictStr], Field(description="The ACL host.")] = None, **kwargs) -> DeleteKafkaAcls200Response:  # noqa: E501
        """Delete ACLs  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Delete the ACLs that match the search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_kafka_acls(cluster_id, resource_type, pattern_type, operation, permission, resource_name, principal, host, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param resource_type: The ACL resource type. (required)
        :type resource_type: AclResourceType
        :param pattern_type: The ACL pattern type. (required)
        :type pattern_type: str
        :param operation: The ACL operation. (required)
        :type operation: str
        :param permission: The ACL permission. (required)
        :type permission: str
        :param resource_name: The ACL resource name.
        :type resource_name: str
        :param principal: The ACL principal. This is the Service Account name or user name.
        :type principal: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: DeleteKafkaAcls200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_kafka_acls_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_kafka_acls_with_http_info(cluster_id, resource_type, pattern_type, operation, permission, resource_name, principal, host, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_kafka_acls_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], resource_type : Annotated[AclResourceType, Field(..., description="The ACL resource type.")], pattern_type : Annotated[StrictStr, Field(..., description="The ACL pattern type.")], operation : Annotated[StrictStr, Field(..., description="The ACL operation.")], permission : Annotated[StrictStr, Field(..., description="The ACL permission.")], resource_name : Annotated[Optional[StrictStr], Field(description="The ACL resource name.")] = None, principal : Annotated[Optional[StrictStr], Field(description="The ACL principal. This is the Service Account name or user name.")] = None, host : Annotated[Optional[StrictStr], Field(description="The ACL host.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete ACLs  # noqa: E501
        ...
        >>> thread = api.delete_kafka_acls_with_http_info(cluster_id, resource_type, pattern_type, operation, permission, resource_name, principal, host, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DeleteKafkaAcls200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_kafka_acls" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('resource_name') is not None:  # noqa: E501
            _query_params.append(('resource_name', _params['resource_name']))

        if _params.get('pattern_type') is not None:  # noqa: E501
            _query_params.append(('pattern_type', _params['pattern_type']))
        ...
        _response_types_map = {
            '200': "DeleteKafkaAcls200Response",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '429': "str",
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/acls', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_kafka_acls(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], resource_type : Annotated[Optional[AclResourceType], Field(description="The ACL resource type.")] = None, resource_name : Annotated[Optional[StrictStr], Field(description="The ACL resource name.")] = None, pattern_type : Annotated[Optional[StrictStr], Field(description="The ACL pattern type.")] = None, principal : Annotated[Optional[StrictStr], Field(description="The ACL principal. This is the Service Account name or user name.")] = None, host : Annotated[Optional[StrictStr], Field(description="The ACL host.")] = None, operation : Annotated[Optional[StrictStr], Field(description="The ACL operation.")] = None, permission : Annotated[Optional[StrictStr], Field(description="The ACL permission.")] = None, **kwargs) -> AclDataList:  # noqa: E501
        """List ACLs  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return a list of ACLs that match the search criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_kafka_acls(cluster_id, resource_type, resource_name, pattern_type, principal, host, operation, permission, async_req=True)
        >>> result = thread.get()

        :param cluster_id: The Kafka cluster ID. (required)
        :type cluster_id: str
        :param resource_type: The ACL resource type.
        :type resource_type: AclResourceType
        :param resource_name: The ACL resource name.
        :type resource_name: str
        :param pattern_type: The ACL pattern type.
        :type pattern_type: str
        :param principal: The ACL principal. This is the Service Account name or user name.
        :type principal: str
        :param host: The ACL host.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_kafka_acls_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_kafka_acls_with_http_info(cluster_id, resource_type, resource_name, pattern_type, principal, host, operation, permission, **kwargs)  # noqa: E501

    @validate_arguments
    def get_kafka_acls_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], resource_type : Annotated[Optional[AclResourceType], Field(description="The ACL resource type.")] = None, resource_name : Annotated[Optional[StrictStr], Field(description="The ACL resource name.")] = None, pattern_type : Annotated[Optional[StrictStr], Field(description="The ACL pattern type.")] = None, principal : Annotated[Optional[StrictStr], Field(description="The ACL principal. This is the Service Account name or user name.")] = None, host : Annotated[Optional[StrictStr], Field(description="The ACL host.")] = None, operation : Annotated[Optional[StrictStr], Field(description="The ACL operation.")] = None, permission : Annotated[Optional[StrictStr], Field(description="The ACL permission.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List ACLs  # noqa: E501
        ...
        >>> thread = api.get_kafka_acls_with_http_info(cluster_id, resource_type, resource_name, pattern_type, principal, host, operation, permission, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AclDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/acls', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
