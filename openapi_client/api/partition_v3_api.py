...
class PartitionV3Api:
    ...
    @validate_arguments
    def get_kafka_partition(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], partition_id : Annotated[StrictInt, Field(..., description="The partition ID.")], **kwargs) -> PartitionData:  # noqa: E501
        """Get Partition  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return the partition with the given `partition_id`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_kafka_partition(cluster_id, topic_name, partition_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_kafka_partition_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_kafka_partition_with_http_info(cluster_id, topic_name, partition_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_kafka_partition_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], partition_id : Annotated[StrictInt, Field(..., description="The partition ID.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get Partition  # noqa: E501
        ...
        >>> thread = api.get_kafka_partition_with_http_info(cluster_id, topic_name, partition_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PartitionData, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method get_kafka_partition" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions/{partition_id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_kafka_partitions(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], **kwargs) -> PartitionDataList:  # noqa: E501
        """List Partitions  # noqa: E501

        [![Generally Available](https://img.shields.io/badge/Lifecycle%20Stage-Generally%20Available-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Return the list of partitions that belong to the specified topic.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_kafka_partitions(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PartitionDataList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_kafka_partitions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_kafka_partitions_with_http_info(cluster_id, topic_name, **kwargs)  # noqa: E501

    @validate_arguments
    def list_kafka_partitions_with_http_info(self, cluster_id : Annotated[StrictStr, Field(..., description="The Kafka cluster ID.")], topic_name : Annotated[StrictStr, Field(..., description="The topic name.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List Partitions  # noqa: E501
        ...
        >>> thread = api.list_kafka_partitions_with_http_info(cluster_id, topic_name, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PartitionDataList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_kafka_partitions" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/kafka/v3/clusters/{cluster_id}/topics/{topic_name}/partitions', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
