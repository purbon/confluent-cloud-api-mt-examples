...
class TransitGatewayAttachmentsNetworkingV1Api:
    ...
    @validate_arguments
    def create_networking_v1_transit_gateway_attachment(self, create_networking_v1_transit_gateway_attachment_request : Optional[CreateNetworkingV1TransitGatewayAttachmentRequest] = None, **kwargs) -> CreateNetworkingV1TransitGatewayAttachment202Response:  # noqa: E501
        """Create a Transit Gateway Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a transit gateway attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_networking_v1_transit_gateway_attachment(create_networking_v1_transit_gateway_attachment_request, async_req=True)
        >>> result = thread.get()

        :param create_networking_v1_transit_gateway_attachment_request:
        :type create_networking_v1_transit_gateway_attachment_request: CreateNetworkingV1TransitGatewayAttachmentRequest
        ...
        :rtype: CreateNetworkingV1TransitGatewayAttachment202Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_networking_v1_transit_gateway_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_networking_v1_transit_gateway_attachment_with_http_info(create_networking_v1_transit_gateway_attachment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_networking_v1_transit_gateway_attachment_with_http_info(self, create_networking_v1_transit_gateway_attachment_request : Optional[CreateNetworkingV1TransitGatewayAttachmentRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Transit Gateway Attachment  # noqa: E501
        ...
        >>> thread = api.create_networking_v1_transit_gateway_attachment_with_http_info(create_networking_v1_transit_gateway_attachment_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateNetworkingV1TransitGatewayAttachment202Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_networking_v1_transit_gateway_attachment_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_networking_v1_transit_gateway_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_networking_v1_transit_gateway_attachment_request'] is not None:
            _body_params = _params['create_networking_v1_transit_gateway_attachment_request']
        ...
        _response_types_map = {
            '202': "CreateNetworkingV1TransitGatewayAttachment202Response",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/transit-gateway-attachments', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_networking_v1_transit_gateway_attachment(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], **kwargs) -> None:  # noqa: E501
        """Delete a Transit Gateway Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a transit gateway attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_networking_v1_transit_gateway_attachment(environment, id, async_req=True)
        >>> result = thread.get()

        :param environment: Scope the operation to the given environment. (required)
        :type environment: str
        :param id: The unique identifier for the transit gateway attachment. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_networking_v1_transit_gateway_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_networking_v1_transit_gateway_attachment_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_networking_v1_transit_gateway_attachment_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Transit Gateway Attachment  # noqa: E501
        ...
        >>> thread = api.delete_networking_v1_transit_gateway_attachment_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_networking_v1_transit_gateway_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/networking/v1/transit-gateway-attachments/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_networking_v1_transit_gateway_attachment(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], **kwargs) -> GetNetworkingV1TransitGatewayAttachment200Response:  # noqa: E501
        """Read a Transit Gateway Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a transit gateway attachment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_networking_v1_transit_gateway_attachment(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetNetworkingV1TransitGatewayAttachment200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_networking_v1_transit_gateway_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_networking_v1_transit_gateway_attachment_with_http_info(environment, id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_networking_v1_transit_gateway_attachment_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Scope the operation to the given environment.")], id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Transit Gateway Attachment  # noqa: E501
        ...
        >>> thread = api.get_networking_v1_transit_gateway_attachment_with_http_info(environment, id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetNetworkingV1TransitGatewayAttachment200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_networking_v1_transit_gateway_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetNetworkingV1TransitGatewayAttachment200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/networking/v1/transit-gateway-attachments/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_networking_v1_transit_gateway_attachments(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, spec_network : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.network. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ListNetworkingV1TransitGatewayAttachments200Response:  # noqa: E501
        """List of Transit Gateway Attachments  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all transit gateway attachments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_networking_v1_transit_gateway_attachments(environment, spec_display_name, status_phase, spec_network, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListNetworkingV1TransitGatewayAttachments200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_networking_v1_transit_gateway_attachments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_networking_v1_transit_gateway_attachments_with_http_info(environment, spec_display_name, status_phase, spec_network, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_networking_v1_transit_gateway_attachments_with_http_info(self, environment : Annotated[StrictStr, Field(..., description="Filter the results by exact match for environment.")], spec_display_name : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.display_name. Pass multiple times to see results matching any of the values.")] = None, status_phase : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for status.phase. Pass multiple times to see results matching any of the values.")] = None, spec_network : Annotated[Optional[conlist(StrictStr)], Field(description="Filter the results by exact match for spec.network. Pass multiple times to see results matching any of the values.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Transit Gateway Attachments  # noqa: E501
        ...
        >>> thread = api.list_networking_v1_transit_gateway_attachments_with_http_info(environment, spec_display_name, status_phase, spec_network, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListNetworkingV1TransitGatewayAttachments200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_networking_v1_transit_gateway_attachments" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListNetworkingV1TransitGatewayAttachments200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/networking/v1/transit-gateway-attachments', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def update_networking_v1_transit_gateway_attachment(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], update_networking_v1_transit_gateway_attachment_request : Optional[UpdateNetworkingV1TransitGatewayAttachmentRequest] = None, **kwargs) -> GetNetworkingV1TransitGatewayAttachment200Response:  # noqa: E501
        """Update a Transit Gateway Attachment  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a transit gateway attachment.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_networking_v1_transit_gateway_attachment(id, update_networking_v1_transit_gateway_attachment_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the transit gateway attachment. (required)
        :type id: str
        :param update_networking_v1_transit_gateway_attachment_request:
        :type update_networking_v1_transit_gateway_attachment_request: UpdateNetworkingV1TransitGatewayAttachmentRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_networking_v1_transit_gateway_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_networking_v1_transit_gateway_attachment_with_http_info(id, update_networking_v1_transit_gateway_attachment_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_networking_v1_transit_gateway_attachment_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the transit gateway attachment.")], update_networking_v1_transit_gateway_attachment_request : Optional[UpdateNetworkingV1TransitGatewayAttachmentRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Transit Gateway Attachment  # noqa: E501
        ...
        >>> thread = api.update_networking_v1_transit_gateway_attachment_with_http_info(id, update_networking_v1_transit_gateway_attachment_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'update_networking_v1_transit_gateway_attachment_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_networking_v1_transit_gateway_attachment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_networking_v1_transit_gateway_attachment_request'] is not None:
            _body_params = _params['update_networking_v1_transit_gateway_attachment_request']
        ...
        return self.api_client.call_api(
            '/networking/v1/transit-gateway-attachments/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
