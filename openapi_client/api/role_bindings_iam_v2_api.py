...
class RoleBindingsIamV2Api:
    ...
    @validate_arguments
    def create_iam_v2_role_binding(self, create_iam_v2_role_binding_request : Optional[CreateIamV2RoleBindingRequest] = None, **kwargs) -> CreateIamV2RoleBindingRequest:  # noqa: E501
        """Create a Role Binding  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a role binding.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_role_binding(create_iam_v2_role_binding_request, async_req=True)
        >>> result = thread.get()

        :param create_iam_v2_role_binding_request:
        :type create_iam_v2_role_binding_request: CreateIamV2RoleBindingRequest
        ...
        :rtype: CreateIamV2RoleBindingRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_iam_v2_role_binding_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_iam_v2_role_binding_with_http_info(create_iam_v2_role_binding_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_iam_v2_role_binding_with_http_info(self, create_iam_v2_role_binding_request : Optional[CreateIamV2RoleBindingRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Role Binding  # noqa: E501
        ...
        >>> thread = api.create_iam_v2_role_binding_with_http_info(create_iam_v2_role_binding_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateIamV2RoleBindingRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_iam_v2_role_binding_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_iam_v2_role_binding" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_iam_v2_role_binding_request'] is not None:
            _body_params = _params['create_iam_v2_role_binding_request']
        ...
        _response_types_map = {
            '201': "CreateIamV2RoleBindingRequest",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '409': "Failure",
    ...
    @validate_arguments
    def delete_iam_v2_role_binding(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the role binding.")], **kwargs) -> GetIamV2RoleBinding200Response:  # noqa: E501
        """Delete a Role Binding  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a role binding.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_iam_v2_role_binding(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the role binding. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetIamV2RoleBinding200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_iam_v2_role_binding_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_iam_v2_role_binding_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_iam_v2_role_binding_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the role binding.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Role Binding  # noqa: E501
        ...
        >>> thread = api.delete_iam_v2_role_binding_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetIamV2RoleBinding200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_iam_v2_role_binding" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetIamV2RoleBinding200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/role-bindings/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_iam_v2_role_binding(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the role binding.")], **kwargs) -> GetIamV2RoleBinding200Response:  # noqa: E501
        """Read a Role Binding  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a role binding.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_iam_v2_role_binding(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_iam_v2_role_binding_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_iam_v2_role_binding_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_iam_v2_role_binding_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the role binding.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Role Binding  # noqa: E501
        ...
        >>> thread = api.get_iam_v2_role_binding_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_iam_v2_role_binding" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def list_iam_v2_role_bindings(self, crn_pattern : Annotated[StrictStr, Field(..., description="Filter the results by a partial search of crn_pattern.")], principal : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for principal.")] = None, role_name : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for role_name.")] = None, page_size : Annotated[Optional[conint(strict=True, le=1000)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> IamV2RoleBindingList:  # noqa: E501
        """List of Role Bindings  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all role bindings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_role_bindings(crn_pattern, principal, role_name, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param crn_pattern: Filter the results by a partial search of crn_pattern. (required)
        :type crn_pattern: str
        :param principal: Filter the results by exact match for principal.
        :type principal: str
        :param role_name: Filter the results by exact match for role_name.
        :type role_name: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IamV2RoleBindingList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_iam_v2_role_bindings_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_iam_v2_role_bindings_with_http_info(crn_pattern, principal, role_name, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_iam_v2_role_bindings_with_http_info(self, crn_pattern : Annotated[StrictStr, Field(..., description="Filter the results by a partial search of crn_pattern.")], principal : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for principal.")] = None, role_name : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for role_name.")] = None, page_size : Annotated[Optional[conint(strict=True, le=1000)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Role Bindings  # noqa: E501
        ...
        >>> thread = api.list_iam_v2_role_bindings_with_http_info(crn_pattern, principal, role_name, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IamV2RoleBindingList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_iam_v2_role_bindings" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('crn_pattern') is not None:  # noqa: E501
            _query_params.append(('crn_pattern', _params['crn_pattern']))
