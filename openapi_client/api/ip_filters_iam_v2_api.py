...
class IPFiltersIamV2Api:
    ...
    @validate_arguments
    def create_iam_v2_ip_filter(self, create_iam_v2_ip_filter_request : Optional[CreateIamV2IpFilterRequest] = None, **kwargs) -> CreateIamV2IpFilterRequest:  # noqa: E501
        """Create an IP Filter  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To IP Filters API](https://img.shields.io/badge/-Request%20Access%20To%20IP%20Filters%20API-%23bc8540)](mailto:ccloud-api-access+iam-v2-early-access@confluent.io?subject=Request%20to%20join%20iam/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to create an IP filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_ip_filter(create_iam_v2_ip_filter_request, async_req=True)
        >>> result = thread.get()

        :param create_iam_v2_ip_filter_request:
        :type create_iam_v2_ip_filter_request: CreateIamV2IpFilterRequest
        ...
        :rtype: CreateIamV2IpFilterRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_iam_v2_ip_filter_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_iam_v2_ip_filter_with_http_info(create_iam_v2_ip_filter_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_iam_v2_ip_filter_with_http_info(self, create_iam_v2_ip_filter_request : Optional[CreateIamV2IpFilterRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an IP Filter  # noqa: E501
        ...
        >>> thread = api.create_iam_v2_ip_filter_with_http_info(create_iam_v2_ip_filter_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateIamV2IpFilterRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_iam_v2_ip_filter_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_iam_v2_ip_filter" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_iam_v2_ip_filter_request'] is not None:
            _body_params = _params['create_iam_v2_ip_filter_request']
        ...
        _response_types_map = {
            '201': "CreateIamV2IpFilterRequest",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '409': "Failure",
    ...
    @validate_arguments
    def delete_iam_v2_ip_filter(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the IP filter.")], **kwargs) -> None:  # noqa: E501
        """Delete an IP Filter  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To IP Filters API](https://img.shields.io/badge/-Request%20Access%20To%20IP%20Filters%20API-%23bc8540)](mailto:ccloud-api-access+iam-v2-early-access@confluent.io?subject=Request%20to%20join%20iam/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to delete an IP filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_iam_v2_ip_filter(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the IP filter. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_iam_v2_ip_filter_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_iam_v2_ip_filter_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_iam_v2_ip_filter_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the IP filter.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an IP Filter  # noqa: E501
        ...
        >>> thread = api.delete_iam_v2_ip_filter_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_iam_v2_ip_filter" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_iam_v2_ip_filter(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the IP filter.")], **kwargs) -> GetIamV2IpFilter200Response:  # noqa: E501
        """Read an IP Filter  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To IP Filters API](https://img.shields.io/badge/-Request%20Access%20To%20IP%20Filters%20API-%23bc8540)](mailto:ccloud-api-access+iam-v2-early-access@confluent.io?subject=Request%20to%20join%20iam/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to read an IP filter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_iam_v2_ip_filter(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetIamV2IpFilter200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_iam_v2_ip_filter_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_iam_v2_ip_filter_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_iam_v2_ip_filter_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the IP filter.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read an IP Filter  # noqa: E501
        ...
        >>> thread = api.get_iam_v2_ip_filter_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetIamV2IpFilter200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_iam_v2_ip_filter" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetIamV2IpFilter200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_iam_v2_ip_filters(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> IamV2IpFilterList:  # noqa: E501
        """List of IP Filters  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To IP Filters API](https://img.shields.io/badge/-Request%20Access%20To%20IP%20Filters%20API-%23bc8540)](mailto:ccloud-api-access+iam-v2-early-access@confluent.io?subject=Request%20to%20join%20iam/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20iam/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Retrieve a sorted, filtered, paginated list of all IP filters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_ip_filters(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IamV2IpFilterList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_iam_v2_ip_filters_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_iam_v2_ip_filters_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_iam_v2_ip_filters_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of IP Filters  # noqa: E501
        ...
        >>> thread = api.list_iam_v2_ip_filters_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IamV2IpFilterList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_iam_v2_ip_filters" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
