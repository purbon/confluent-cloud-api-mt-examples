...
class SubjectsV1Api:
    ...
    @validate_arguments
    def delete_schema_version(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], permanent : Annotated[Optional[StrictBool], Field(description="Whether to perform a permanent delete")] = None, **kwargs) -> int:  # noqa: E501
        """Delete schema version  # noqa: E501

        Deletes a specific version of the schema registered under this subject. This only deletes the version and the schema ID remains intact making it still possible to decode data using the schema ID. This API is recommended to be used only in development environments or under extreme circumstances where-in, its required to delete a previously registered schema for compatibility purposes or re-register previously registered schema.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_schema_version(subject, version, permanent, async_req=True)
        >>> result = thread.get()

        :param subject: Name of the subject (required)
        :type subject: str
        :param version: Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served. (required)
        :type version: str
        :param permanent: Whether to perform a permanent delete
        :type permanent: bool
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_schema_version_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_schema_version_with_http_info(subject, version, permanent, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_schema_version_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], permanent : Annotated[Optional[StrictBool], Field(description="Whether to perform a permanent delete")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete schema version  # noqa: E501
        ...
        >>> thread = api.delete_schema_version_with_http_info(subject, version, permanent, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method delete_schema_version" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('permanent') is not None:  # noqa: E501
            _query_params.append(('permanent', _params['permanent']))
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(
            ['application/vnd.schemaregistry.v1+json', 'application/vnd.schemaregistry+json; qs=0.9', 'application/json; qs=0.5', 'application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/subjects/{subject}/versions/{version}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_subject(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], permanent : Annotated[Optional[StrictBool], Field(description="Whether to perform a permanent delete")] = None, **kwargs) -> List[int]:  # noqa: E501
        """Delete subject  # noqa: E501

        Deletes the specified subject and its associated compatibility level if registered. It is recommended to use this API only when a topic needs to be recycled or in development environment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_subject(subject, permanent, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_subject_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_subject_with_http_info(subject, permanent, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_subject_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], permanent : Annotated[Optional[StrictBool], Field(description="Whether to perform a permanent delete")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete subject  # noqa: E501
        ...
        >>> thread = api.delete_subject_with_http_info(subject, permanent, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_referenced_by(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], **kwargs) -> List[int]:  # noqa: E501
        """List schemas referencing a schema  # noqa: E501

        Retrieves the IDs of schemas that reference the specified schema.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_referenced_by(subject, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_referenced_by_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_referenced_by_with_http_info(subject, version, **kwargs)  # noqa: E501

    @validate_arguments
    def get_referenced_by_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List schemas referencing a schema  # noqa: E501
        ...
        >>> thread = api.get_referenced_by_with_http_info(subject, version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_referenced_by" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/subjects/{subject}/versions/{version}/referencedby', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_schema_by_version(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schema")] = None, **kwargs) -> ModelSchema:  # noqa: E501
        """Get schema by version  # noqa: E501

        Retrieves a specific version of the schema registered under this subject.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schema_by_version(subject, version, deleted, async_req=True)
        >>> result = thread.get()
        ...
        :param version: Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served. (required)
        :type version: str
        :param deleted: Whether to include deleted schema
        :type deleted: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_schema_by_version_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_schema_by_version_with_http_info(subject, version, deleted, **kwargs)  # noqa: E501

    @validate_arguments
    def get_schema_by_version_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schema")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get schema by version  # noqa: E501
        ...
        >>> thread = api.get_schema_by_version_with_http_info(subject, version, deleted, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_schema_by_version" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_schema_only1(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schema")] = None, **kwargs) -> str:  # noqa: E501
        """Get schema string by version  # noqa: E501

        Retrieves the schema for the specified version of this subject. Only the unescaped schema string is returned.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_schema_only1(subject, version, deleted, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_schema_only1_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_schema_only1_with_http_info(subject, version, deleted, **kwargs)  # noqa: E501

    @validate_arguments
    def get_schema_only1_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], version : Annotated[StrictStr, Field(..., description="Version of the schema to be returned. Valid values for versionId are between [1,2^31-1] or the string \"latest\". \"latest\" returns the last registered schema under the specified subject. Note that there may be a new latest schema that gets registered right after this request is served.")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schema")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get schema string by version  # noqa: E501
        ...
        >>> thread = api.get_schema_only1_with_http_info(subject, version, deleted, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_schema_only1" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/subjects/{subject}/versions/{version}/schema', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list(self, subject_prefix : Annotated[Optional[StrictStr], Field(description="Subject name prefix")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to look up deleted subjects")] = None, **kwargs) -> List[str]:  # noqa: E501
        """List subjects  # noqa: E501

        Retrieves a list of registered subjects matching specified parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list(subject_prefix, deleted, async_req=True)
        >>> result = thread.get()

        :param subject_prefix: Subject name prefix
        :type subject_prefix: str
        :param deleted: Whether to look up deleted subjects
        :type deleted: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.list_with_http_info(subject_prefix, deleted, **kwargs)  # noqa: E501

    @validate_arguments
    def list_with_http_info(self, subject_prefix : Annotated[Optional[StrictStr], Field(description="Subject name prefix")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to look up deleted subjects")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List subjects  # noqa: E501
        ...
        >>> thread = api.list_with_http_info(subject_prefix, deleted, async_req=True)
        >>> result = thread.get()
        ...
        # process the query parameters
        _query_params = []
        if _params.get('subject_prefix') is not None:  # noqa: E501
            _query_params.append(('subjectPrefix', _params['subject_prefix']))
    ...
    @validate_arguments
    def list_versions(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schemas")] = None, **kwargs) -> List[int]:  # noqa: E501
        """List versions under subject  # noqa: E501

        Retrieves a list of versions registered under the specified subject.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_versions(subject, deleted, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.list_versions_with_http_info(subject, deleted, **kwargs)  # noqa: E501

    @validate_arguments
    def list_versions_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], deleted : Annotated[Optional[StrictBool], Field(description="Whether to include deleted schemas")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List versions under subject  # noqa: E501
        ...
        >>> thread = api.list_versions_with_http_info(subject, deleted, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def look_up_schema_under_subject(self, subject : Annotated[StrictStr, Field(..., description="Subject under which the schema will be registered")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], normalize : Annotated[Optional[StrictBool], Field(description="Whether to lookup the normalized schema")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to lookup deleted schemas")] = None, **kwargs) -> ModelSchema:  # noqa: E501
        """Lookup schema under subject  # noqa: E501

        Check if a schema has already been registered under the specified subject. If so, this returns the schema string along with its globally unique identifier, its version under this subject and the subject name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.look_up_schema_under_subject(subject, register_schema_request, normalize, deleted, async_req=True)
        >>> result = thread.get()

        :param subject: Subject under which the schema will be registered (required)
        :type subject: str
        :param register_schema_request: Schema (required)
        :type register_schema_request: RegisterSchemaRequest
        :param normalize: Whether to lookup the normalized schema
        :type normalize: bool
        :param deleted: Whether to lookup deleted schemas
        :type deleted: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the look_up_schema_under_subject_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.look_up_schema_under_subject_with_http_info(subject, register_schema_request, normalize, deleted, **kwargs)  # noqa: E501

    @validate_arguments
    def look_up_schema_under_subject_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Subject under which the schema will be registered")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], normalize : Annotated[Optional[StrictBool], Field(description="Whether to lookup the normalized schema")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Whether to lookup deleted schemas")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Lookup schema under subject  # noqa: E501
        ...
        >>> thread = api.look_up_schema_under_subject_with_http_info(subject, register_schema_request, normalize, deleted, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method look_up_schema_under_subject" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('normalize') is not None:  # noqa: E501
            _query_params.append(('normalize', _params['normalize']))
        ...
        # process the body parameter
        _body_params = None
        if _params['register_schema_request'] is not None:
            _body_params = _params['register_schema_request']
        ...
        _content_types_list = _params.get('_content_type',
            self.api_client.select_header_content_type(
                ['application/vnd.schemaregistry.v1+json', 'application/vnd.schemaregistry+json', 'application/json', 'application/octet-stream']))
    ...
    @validate_arguments
    def register(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], normalize : Annotated[Optional[StrictBool], Field(description="Whether to register the normalized schema")] = None, **kwargs) -> RegisterSchemaResponse:  # noqa: E501
        """Register schema under a subject  # noqa: E501

        Register a new schema under the specified subject. If successfully registered, this returns the unique identifier of this schema in the registry. The returned identifier should be used to retrieve this schema from the schemas resource and is different from the schema's version which is associated with the subject. If the same schema is registered under a different subject, the same identifier will be returned. However, the version of the schema may be different under different subjects. A schema should be compatible with the previously registered schema or schemas (if there are any) as per the configured compatibility level. The configured compatibility level can be obtained by issuing a GET http:get:: /config/(string: subject). If that returns null, then GET http:get:: /config When there are multiple instances of Schema Registry running in the same cluster, the schema registration request will be forwarded to one of the instances designated as the primary. If the primary is not available, the client will get an error code indicating that the forwarding has failed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.register(subject, register_schema_request, normalize, async_req=True)
        >>> result = thread.get()
        ...
        :param register_schema_request: Schema (required)
        :type register_schema_request: RegisterSchemaRequest
        :param normalize: Whether to register the normalized schema
        :type normalize: bool
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.register_with_http_info(subject, register_schema_request, normalize, **kwargs)  # noqa: E501

    @validate_arguments
    def register_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Name of the subject")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], normalize : Annotated[Optional[StrictBool], Field(description="Whether to register the normalized schema")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Register schema under a subject  # noqa: E501
        ...
        >>> thread = api.register_with_http_info(subject, register_schema_request, normalize, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RegisterSchemaResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            '/subjects/{subject}/versions', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
