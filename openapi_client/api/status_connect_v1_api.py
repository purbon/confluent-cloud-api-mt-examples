...
class StatusConnectV1Api:
    ...
    @validate_arguments
    def list_connectv1_connector_tasks(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> List[ConnectV1ConnectorsInner]:  # noqa: E501
        """List of Connector Tasks  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Get a list of tasks currently running for the connector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_connectv1_connector_tasks(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: List[ConnectV1ConnectorsInner]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_connectv1_connector_tasks_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_connectv1_connector_tasks_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_connectv1_connector_tasks_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List of Connector Tasks  # noqa: E501
        ...
        >>> thread = api.list_connectv1_connector_tasks_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[ConnectV1ConnectorsInner], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method list_connectv1_connector_tasks" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[ConnectV1ConnectorsInner]",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/tasks', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def read_connectv1_connector_status(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ReadConnectv1ConnectorStatus200Response:  # noqa: E501
        """Read a Connector Status  # noqa: E501

        Get current status of the connector. This includes whether it is running, failed, or paused. Also includes which worker it is assigned to, error information if it has failed, and the state of all its tasks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.read_connectv1_connector_status(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ReadConnectv1ConnectorStatus200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_connectv1_connector_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_connectv1_connector_status_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_connectv1_connector_status_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Connector Status  # noqa: E501
        ...
        >>> thread = api.read_connectv1_connector_status_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ReadConnectv1ConnectorStatus200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_connectv1_connector_status" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ReadConnectv1ConnectorStatus200Response",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "ConnectV1ConnectorError",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/status', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
