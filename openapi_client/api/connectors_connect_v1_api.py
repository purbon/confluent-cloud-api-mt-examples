...
class ConnectorsConnectV1Api:
    ...
    @validate_arguments
    def create_connectv1_connector(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], create_connectv1_connector_request : Optional[CreateConnectv1ConnectorRequest] = None, **kwargs) -> ConnectV1Connector:  # noqa: E501
        """Create a Connector  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Create a new connector. Returns the new connector information if successful.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_connectv1_connector(environment_id, kafka_cluster_id, create_connectv1_connector_request, async_req=True)
        >>> result = thread.get()

        :param environment_id: The unique identifier of the environment this resource belongs to. (required)
        :type environment_id: str
        :param kafka_cluster_id: The unique identifier for the Kafka cluster. (required)
        :type kafka_cluster_id: str
        :param create_connectv1_connector_request: 
        :type create_connectv1_connector_request: CreateConnectv1ConnectorRequest
        ...
        :rtype: ConnectV1Connector
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_connectv1_connector_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_connectv1_connector_with_http_info(environment_id, kafka_cluster_id, create_connectv1_connector_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_connectv1_connector_with_http_info(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], create_connectv1_connector_request : Optional[CreateConnectv1ConnectorRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Connector  # noqa: E501
        ...
        >>> thread = api.create_connectv1_connector_with_http_info(environment_id, kafka_cluster_id, create_connectv1_connector_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConnectV1Connector, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_connectv1_connector" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['kafka_cluster_id']:
            _path_params['kafka_cluster_id'] = _params['kafka_cluster_id']
        ...
        _body_params = None
        if _params['create_connectv1_connector_request'] is not None:
            _body_params = _params['create_connectv1_connector_request']
        ...
        _auth_settings = ['cloud-api-key', 'confluent-sts-access-token']  # noqa: E501

        _response_types_map = {
            '201': "ConnectV1Connector",
            '400': "CreateConnectv1Connector400Response",
            '401': "ConnectV1ConnectorError",
            '429': None,
            '500': "CreateConnectv1Connector500Response",
        }

        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_or_update_connectv1_connector_config(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], request_body : Annotated[Optional[Dict[str, StrictStr]], Field(description="Configuration parameters for the connector. All values should be strings.")] = None, **kwargs) -> ConnectV1Connector:  # noqa: E501
        """Create or Update a Connector Configuration  # noqa: E501

        Create a new connector using the given configuration, or update the configuration for an existing connector. Returns information about the connector after the change has been made.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_or_update_connectv1_connector_config(connector_name, environment_id, kafka_cluster_id, request_body, async_req=True)
        >>> result = thread.get()

        :param connector_name: The unique name of the connector. (required)
        :type connector_name: str
        :param environment_id: The unique identifier of the environment this resource belongs to. (required)
        :type environment_id: str
        :param kafka_cluster_id: The unique identifier for the Kafka cluster. (required)
        :type kafka_cluster_id: str
        :param request_body: Configuration parameters for the connector. All values should be strings.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_or_update_connectv1_connector_config_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_or_update_connectv1_connector_config_with_http_info(connector_name, environment_id, kafka_cluster_id, request_body, **kwargs)  # noqa: E501

    @validate_arguments
    def create_or_update_connectv1_connector_config_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], request_body : Annotated[Optional[Dict[str, StrictStr]], Field(description="Configuration parameters for the connector. All values should be strings.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create or Update a Connector Configuration  # noqa: E501
        ...
        >>> thread = api.create_or_update_connectv1_connector_config_with_http_info(connector_name, environment_id, kafka_cluster_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_or_update_connectv1_connector_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['connector_name']:
            _path_params['connector_name'] = _params['connector_name']
        ...
        _response_types_map = {
            '201': "ConnectV1Connector",
            '400': "ConnectV1ConnectorError",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "CreateConnectv1Connector500Response",
        }

        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/config', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_connectv1_connector(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> DeleteConnectv1Connector200Response:  # noqa: E501
        """Delete a Connector  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Delete a connector. Halts all tasks and deletes the connector configuration.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_connectv1_connector(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: DeleteConnectv1Connector200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_connectv1_connector_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_connectv1_connector_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Connector  # noqa: E501
        ...
        >>> thread = api.delete_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DeleteConnectv1Connector200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_connectv1_connector" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "DeleteConnectv1Connector200Response",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "ConnectV1ConnectorError",
        }

        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_connectv1_connector_config(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> GetConnectv1ConnectorConfig200Response:  # noqa: E501
        """Read a Connector Configuration  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Get the configuration for the connector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_connectv1_connector_config(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetConnectv1ConnectorConfig200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_connectv1_connector_config_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_connectv1_connector_config_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_connectv1_connector_config_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Connector Configuration  # noqa: E501
        ...
        >>> thread = api.get_connectv1_connector_config_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetConnectv1ConnectorConfig200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_connectv1_connector_config" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetConnectv1ConnectorConfig200Response",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "ConnectV1ConnectorError",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}/config', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_connectv1_connectors(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> List[str]:  # noqa: E501
        """List of Connectors  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a list of \"names\" of the active connectors. You can then make a [read request](#operation/readConnectv1Connector) for a specific connector by name.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_connectv1_connectors(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_connectv1_connectors_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_connectv1_connectors_with_http_info(environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_connectv1_connectors_with_http_info(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """List of Connectors  # noqa: E501
        ...
        >>> thread = api.list_connectv1_connectors_with_http_info(environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_connectv1_connectors" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_connectv1_connectors_with_expansions(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], expand : Annotated[Optional[StrictStr], Field(description="- id : Returns metadata of each connector such as id and id type. - info : Returns metadata of each connector such as the configuration, task information, and type of connector. - status : Returns additional state information of each connector including their status and tasks.")] = None, **kwargs) -> Dict[str, ConnectV1ConnectorExpansion]:  # noqa: E501
        """List of Connectors with Expansions  # noqa: E501
        ...
        >>> thread = api.list_connectv1_connectors_with_expansions(environment_id, kafka_cluster_id, expand, async_req=True)
        >>> result = thread.get()
        ...
        :param kafka_cluster_id: The unique identifier for the Kafka cluster. (required)
        :type kafka_cluster_id: str
        :param expand: - id : Returns metadata of each connector such as id and id type. - info : Returns metadata of each connector such as the configuration, task information, and type of connector. - status : Returns additional state information of each connector including their status and tasks.
        :type expand: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Dict[str, ConnectV1ConnectorExpansion]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_connectv1_connectors_with_expansions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_connectv1_connectors_with_expansions_with_http_info(environment_id, kafka_cluster_id, expand, **kwargs)  # noqa: E501

    @validate_arguments
    def list_connectv1_connectors_with_expansions_with_http_info(self, environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], expand : Annotated[Optional[StrictStr], Field(description="- id : Returns metadata of each connector such as id and id type. - info : Returns metadata of each connector such as the configuration, task information, and type of connector. - status : Returns additional state information of each connector including their status and tasks.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Connectors with Expansions  # noqa: E501
        ...
        >>> thread = api.list_connectv1_connectors_with_expansions_with_http_info(environment_id, kafka_cluster_id, expand, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Dict[str, ConnectV1ConnectorExpansion], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_connectv1_connectors_with_expansions" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "Dict[str, ConnectV1ConnectorExpansion]",
            '401': "ConnectV1ConnectorError",
            '404': "ConnectV1ConnectorError",
            '429': None,
            '500': "ConnectV1ConnectorError",
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors?expand=info,status,id', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def read_connectv1_connector(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ConnectV1Connector:  # noqa: E501
        """Read a Connector  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Get information about the connector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.read_connectv1_connector(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the read_connectv1_connector_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.read_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, **kwargs)  # noqa: E501

    @validate_arguments
    def read_connectv1_connector_with_http_info(self, connector_name : Annotated[StrictStr, Field(..., description="The unique name of the connector.")], environment_id : Annotated[StrictStr, Field(..., description="The unique identifier of the environment this resource belongs to.")], kafka_cluster_id : Annotated[StrictStr, Field(..., description="The unique identifier for the Kafka cluster.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Connector  # noqa: E501
        ...
        >>> thread = api.read_connectv1_connector_with_http_info(connector_name, environment_id, kafka_cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_connectv1_connector" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors/{connector_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
