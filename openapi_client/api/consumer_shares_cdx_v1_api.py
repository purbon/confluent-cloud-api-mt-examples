...
class ConsumerSharesCdxV1Api:
    ...
    @validate_arguments
    def delete_cdx_v1_consumer_share(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer share.")], **kwargs) -> None:  # noqa: E501
        """Delete a Consumer Share  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a consumer share.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_cdx_v1_consumer_share(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the consumer share. (required)
        :type id: str
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_cdx_v1_consumer_share_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_cdx_v1_consumer_share_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_cdx_v1_consumer_share_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer share.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Consumer Share  # noqa: E501
        ...
        >>> thread = api.delete_cdx_v1_consumer_share_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_cdx_v1_consumer_share" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/consumer-shares/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_cdx_v1_consumer_share(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer share.")], **kwargs) -> GetCdxV1ConsumerShare200Response:  # noqa: E501
        """Read a Consumer Share  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a consumer share.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cdx_v1_consumer_share(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetCdxV1ConsumerShare200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_cdx_v1_consumer_share_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_cdx_v1_consumer_share_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_cdx_v1_consumer_share_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer share.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Consumer Share  # noqa: E501
        ...
        >>> thread = api.get_cdx_v1_consumer_share_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetCdxV1ConsumerShare200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_cdx_v1_consumer_share" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetCdxV1ConsumerShare200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_cdx_v1_consumer_shares(self, shared_resource : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for shared_resource.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shares")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> CdxV1ConsumerShareList:  # noqa: E501
        """List of Consumer Shares  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all consumer shares.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_cdx_v1_consumer_shares(shared_resource, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CdxV1ConsumerShareList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_cdx_v1_consumer_shares_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_cdx_v1_consumer_shares_with_http_info(shared_resource, include_deleted, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_cdx_v1_consumer_shares_with_http_info(self, shared_resource : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for shared_resource.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shares")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Consumer Shares  # noqa: E501
        ...
        >>> thread = api.list_cdx_v1_consumer_shares_with_http_info(shared_resource, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CdxV1ConsumerShareList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_cdx_v1_consumer_shares" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
