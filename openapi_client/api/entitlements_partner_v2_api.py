...
class EntitlementsPartnerV2Api:
    ...
    @validate_arguments
    def create_partner_v2_entitlement(self, create_partner_v2_entitlement_request : Optional[CreatePartnerV2EntitlementRequest] = None, **kwargs) -> CreatePartnerV2EntitlementRequest:  # noqa: E501
        """Create an Entitlement  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Partner v2](https://img.shields.io/badge/-Request%20Access%20To%20Partner%20v2-%23bc8540)](mailto:ccloud-api-access+partner-v2-early-access@confluent.io?subject=Request%20to%20join%20partner/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20partner/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to create an entitlement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_partner_v2_entitlement(create_partner_v2_entitlement_request, async_req=True)
        >>> result = thread.get()

        :param create_partner_v2_entitlement_request:
        :type create_partner_v2_entitlement_request: CreatePartnerV2EntitlementRequest
        ...
        :rtype: CreatePartnerV2EntitlementRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_partner_v2_entitlement_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_partner_v2_entitlement_with_http_info(create_partner_v2_entitlement_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_partner_v2_entitlement_with_http_info(self, create_partner_v2_entitlement_request : Optional[CreatePartnerV2EntitlementRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an Entitlement  # noqa: E501
        ...
        >>> thread = api.create_partner_v2_entitlement_with_http_info(create_partner_v2_entitlement_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreatePartnerV2EntitlementRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_partner_v2_entitlement_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_partner_v2_entitlement" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_partner_v2_entitlement_request'] is not None:
            _body_params = _params['create_partner_v2_entitlement_request']
        ...
        _response_types_map = {
            '201': "CreatePartnerV2EntitlementRequest",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '409': "Failure",
    ...
    @validate_arguments
    def get_partner_v2_entitlement(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the entitlement.")], organization_id : Annotated[Optional[StrictStr], Field(description="Scope the operation to the given organization.id.")] = None, **kwargs) -> CreatePartnerV2EntitlementRequest:  # noqa: E501
        """Read an Entitlement  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Partner v2](https://img.shields.io/badge/-Request%20Access%20To%20Partner%20v2-%23bc8540)](mailto:ccloud-api-access+partner-v2-early-access@confluent.io?subject=Request%20to%20join%20partner/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20partner/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Make a request to read an entitlement.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_partner_v2_entitlement(id, organization_id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the entitlement. (required)
        :type id: str
        :param organization_id: Scope the operation to the given organization.id.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_partner_v2_entitlement_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_partner_v2_entitlement_with_http_info(id, organization_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_partner_v2_entitlement_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the entitlement.")], organization_id : Annotated[Optional[StrictStr], Field(description="Scope the operation to the given organization.id.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Entitlement  # noqa: E501
        ...
        >>> thread = api.get_partner_v2_entitlement_with_http_info(id, organization_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_partner_v2_entitlement" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('organization_id') is not None:  # noqa: E501
            _query_params.append(('organization.id', _params['organization_id']))
        ...
        _response_types_map = {
            '200': "CreatePartnerV2EntitlementRequest",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/partner/v2/entitlements/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_partner_v2_entitlements(self, organization_id : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for organization.id.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> PartnerV2EntitlementList:  # noqa: E501
        """List of Entitlements  # noqa: E501

        [![Early Access](https://img.shields.io/badge/Lifecycle%20Stage-Early%20Access-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy) [![Request Access To Partner v2](https://img.shields.io/badge/-Request%20Access%20To%20Partner%20v2-%23bc8540)](mailto:ccloud-api-access+partner-v2-early-access@confluent.io?subject=Request%20to%20join%20partner/v2%20API%20Early%20Access&body=I%E2%80%99d%20like%20to%20join%20the%20Confluent%20Cloud%20API%20Early%20Access%20for%20partner/v2%20to%20provide%20early%20feedback%21%20My%20Cloud%20Organization%20ID%20is%20%3Cretrieve%20from%20https%3A//confluent.cloud/settings/billing/payment%3E.)  Retrieve a sorted, filtered, paginated list of all entitlements.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_partner_v2_entitlements(organization_id, page_size, page_token, async_req=True)
        >>> result = thread.get()

        :param organization_id: Filter the results by exact match for organization.id.
        :type organization_id: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PartnerV2EntitlementList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_partner_v2_entitlements_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_partner_v2_entitlements_with_http_info(organization_id, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_partner_v2_entitlements_with_http_info(self, organization_id : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for organization.id.")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Entitlements  # noqa: E501
        ...
        >>> thread = api.list_partner_v2_entitlements_with_http_info(organization_id, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PartnerV2EntitlementList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_partner_v2_entitlements" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
