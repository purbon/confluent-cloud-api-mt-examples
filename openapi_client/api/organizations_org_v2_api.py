...
class OrganizationsOrgV2Api:
    ...
    @validate_arguments
    def get_org_v2_organization(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], **kwargs) -> GetOrgV2Organization200Response:  # noqa: E501
        """Read an Organization  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read an organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_org_v2_organization(id, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: GetOrgV2Organization200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_org_v2_organization_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_org_v2_organization_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_org_v2_organization_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read an Organization  # noqa: E501
        ...
        >>> thread = api.get_org_v2_organization_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetOrgV2Organization200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_org_v2_organization" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetOrgV2Organization200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
    ...
    @validate_arguments
    def list_org_v2_organizations(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> OrgV2OrganizationList:  # noqa: E501
        """List of Organizations  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all organizations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_org_v2_organizations(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: OrgV2OrganizationList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_org_v2_organizations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_org_v2_organizations_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_org_v2_organizations_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Organizations  # noqa: E501
        ...
        >>> thread = api.list_org_v2_organizations_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(OrgV2OrganizationList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_org_v2_organizations" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_org_v2_organization(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], org_v2_organization : Optional[OrgV2Organization] = None, **kwargs) -> GetOrgV2Organization200Response:  # noqa: E501
        """Update an Organization  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update an organization.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_org_v2_organization(id, org_v2_organization, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the organization. (required)
        :type id: str
        :param org_v2_organization:
        :type org_v2_organization: OrgV2Organization
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_org_v2_organization_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_org_v2_organization_with_http_info(id, org_v2_organization, **kwargs)  # noqa: E501

    @validate_arguments
    def update_org_v2_organization_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the organization.")], org_v2_organization : Optional[OrgV2Organization] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update an Organization  # noqa: E501
        ...
        >>> thread = api.update_org_v2_organization_with_http_info(id, org_v2_organization, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_org_v2_organization" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['org_v2_organization'] is not None:
            _body_params = _params['org_v2_organization']
