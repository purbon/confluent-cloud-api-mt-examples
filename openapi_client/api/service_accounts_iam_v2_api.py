...
class ServiceAccountsIamV2Api:
    ...
    @validate_arguments
    def create_iam_v2_service_account(self, create_iam_v2_service_account_request : Optional[CreateIamV2ServiceAccountRequest] = None, **kwargs) -> CreateIamV2ServiceAccountRequest:  # noqa: E501
        """Create a Service Account  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to create a service account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_iam_v2_service_account(create_iam_v2_service_account_request, async_req=True)
        >>> result = thread.get()

        :param create_iam_v2_service_account_request:
        :type create_iam_v2_service_account_request: CreateIamV2ServiceAccountRequest
        ...
        :rtype: CreateIamV2ServiceAccountRequest
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_iam_v2_service_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_iam_v2_service_account_with_http_info(create_iam_v2_service_account_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_iam_v2_service_account_with_http_info(self, create_iam_v2_service_account_request : Optional[CreateIamV2ServiceAccountRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Service Account  # noqa: E501
        ...
        >>> thread = api.create_iam_v2_service_account_with_http_info(create_iam_v2_service_account_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateIamV2ServiceAccountRequest, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'create_iam_v2_service_account_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_iam_v2_service_account" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_iam_v2_service_account_request'] is not None:
            _body_params = _params['create_iam_v2_service_account_request']
        ...
        _response_types_map = {
            '201': "CreateIamV2ServiceAccountRequest",
            '400': "Failure",
            '401': "Failure",
            '402': "Failure",
            '403': "Failure",
    ...
    @validate_arguments
    def delete_iam_v2_service_account(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], **kwargs) -> None:  # noqa: E501
        """Delete a Service Account  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to delete a service account.  If successful, this request will also recursively delete all of the service account's associated resources, including its cloud and cluster API keys.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_iam_v2_service_account(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the service account. (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_iam_v2_service_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_iam_v2_service_account_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_iam_v2_service_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a Service Account  # noqa: E501
        ...
        >>> thread = api.delete_iam_v2_service_account_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_iam_v2_service_account" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/iam/v2/service-accounts/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_iam_v2_service_account(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], **kwargs) -> GetIamV2ServiceAccount200Response:  # noqa: E501
        """Read a Service Account  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a service account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_iam_v2_service_account(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetIamV2ServiceAccount200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_iam_v2_service_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_iam_v2_service_account_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_iam_v2_service_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Service Account  # noqa: E501
        ...
        >>> thread = api.get_iam_v2_service_account_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetIamV2ServiceAccount200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_iam_v2_service_account" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetIamV2ServiceAccount200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/iam/v2/service-accounts/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_iam_v2_service_accounts(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> IamV2ServiceAccountList:  # noqa: E501
        """List of Service Accounts  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all service accounts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_iam_v2_service_accounts(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: IamV2ServiceAccountList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_iam_v2_service_accounts_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_iam_v2_service_accounts_with_http_info(page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_iam_v2_service_accounts_with_http_info(self, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Service Accounts  # noqa: E501
        ...
        >>> thread = api.list_iam_v2_service_accounts_with_http_info(page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(IamV2ServiceAccountList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_iam_v2_service_accounts" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_iam_v2_service_account(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], iam_v2_service_account_update : Optional[IamV2ServiceAccountUpdate] = None, **kwargs) -> GetIamV2ServiceAccount200Response:  # noqa: E501
        """Update a Service Account  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to update a service account.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_iam_v2_service_account(id, iam_v2_service_account_update, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the service account. (required)
        :type id: str
        :param iam_v2_service_account_update:
        :type iam_v2_service_account_update: IamV2ServiceAccountUpdate
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_iam_v2_service_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_iam_v2_service_account_with_http_info(id, iam_v2_service_account_update, **kwargs)  # noqa: E501

    @validate_arguments
    def update_iam_v2_service_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the service account.")], iam_v2_service_account_update : Optional[IamV2ServiceAccountUpdate] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a Service Account  # noqa: E501
        ...
        >>> thread = api.update_iam_v2_service_account_with_http_info(id, iam_v2_service_account_update, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_iam_v2_service_account" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['iam_v2_service_account_update'] is not None:
            _body_params = _params['iam_v2_service_account_update']
        ...
        return self.api_client.call_api(
            '/iam/v2/service-accounts/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
