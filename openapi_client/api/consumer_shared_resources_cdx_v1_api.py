...
class ConsumerSharedResourcesCdxV1Api:
    ...
    @validate_arguments
    def get_cdx_v1_consumer_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], **kwargs) -> GetCdxV1ConsumerSharedResource200Response:  # noqa: E501
        """Read a Consumer Shared Resource  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Make a request to read a consumer shared resource.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_cdx_v1_consumer_shared_resource(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the consumer shared resource. (required)
        :type id: str
        ...
        :rtype: GetCdxV1ConsumerSharedResource200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_cdx_v1_consumer_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_cdx_v1_consumer_shared_resource_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_cdx_v1_consumer_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read a Consumer Shared Resource  # noqa: E501
        ...
        >>> thread = api.get_cdx_v1_consumer_shared_resource_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetCdxV1ConsumerSharedResource200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_cdx_v1_consumer_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetCdxV1ConsumerSharedResource200Response",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '404': "Failure",
        ...
        return self.api_client.call_api(
            '/cdx/v1/consumer-shared-resources/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def image_cdx_v1_consumer_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> bytearray:  # noqa: E501
        ...
        >>> thread = api.image_cdx_v1_consumer_shared_resource(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the image_cdx_v1_consumer_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.image_cdx_v1_consumer_shared_resource_with_http_info(id, file_name, **kwargs)  # noqa: E501

    @validate_arguments
    def image_cdx_v1_consumer_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], file_name : Annotated[StrictStr, Field(..., description="The File Name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get image for shared resource  # noqa: E501
        ...
        >>> thread = api.image_cdx_v1_consumer_shared_resource_with_http_info(id, file_name, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method image_cdx_v1_consumer_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/consumer-shared-resources/{id}/images/{file_name}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_cdx_v1_consumer_shared_resources(self, stream_share : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for stream_share.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shared resources")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> CdxV1ConsumerSharedResourceList:  # noqa: E501
        """List of Consumer Shared Resources  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Retrieve a sorted, filtered, paginated list of all consumer shared resources.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_cdx_v1_consumer_shared_resources(stream_share, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CdxV1ConsumerSharedResourceList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_cdx_v1_consumer_shared_resources_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.list_cdx_v1_consumer_shared_resources_with_http_info(stream_share, include_deleted, page_size, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_cdx_v1_consumer_shared_resources_with_http_info(self, stream_share : Annotated[Optional[StrictStr], Field(description="Filter the results by exact match for stream_share.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include deactivated shared resources")] = None, page_size : Annotated[Optional[conint(strict=True, le=100)], Field(description="A pagination size for collection requests.")] = None, page_token : Annotated[Optional[constr(strict=True, max_length=255)], Field(description="An opaque pagination token for collection requests.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List of Consumer Shared Resources  # noqa: E501
        ...
        >>> thread = api.list_cdx_v1_consumer_shared_resources_with_http_info(stream_share, include_deleted, page_size, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CdxV1ConsumerSharedResourceList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_cdx_v1_consumer_shared_resources" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CdxV1ConsumerSharedResourceList",
            '400': "Failure",
            '401': "Failure",
            '403': "Failure",
            '429': None,
        ...
        return self.api_client.call_api(
            '/cdx/v1/consumer-shared-resources', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def network_cdx_v1_consumer_shared_resource(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], **kwargs) -> CdxV1Network:  # noqa: E501
        """Get shared resource's network configuration  # noqa: E501

        [![General Availability](https://img.shields.io/badge/Lifecycle%20Stage-General%20Availability-%2345c6e8)](#section/Versioning/API-Lifecycle-Policy)  Returns network information of the shared resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.network_cdx_v1_consumer_shared_resource(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the network_cdx_v1_consumer_shared_resource_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.network_cdx_v1_consumer_shared_resource_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def network_cdx_v1_consumer_shared_resource_with_http_info(self, id : Annotated[StrictStr, Field(..., description="The unique identifier for the consumer shared resource.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get shared resource's network configuration  # noqa: E501
        ...
        >>> thread = api.network_cdx_v1_consumer_shared_resource_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CdxV1Network, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method network_cdx_v1_consumer_shared_resource" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/cdx/v1/consumer-shared-resources/{id}:network', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
