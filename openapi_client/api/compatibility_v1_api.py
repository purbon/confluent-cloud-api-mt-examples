...
class CompatibilityV1Api:
    ...
    @validate_arguments
    def test_compatibility_by_subject_name(self, subject : Annotated[StrictStr, Field(..., description="Subject of the schema version against which compatibility is to be tested")], version : Annotated[StrictStr, Field(..., description="Version of the subject's schema against which compatibility is to be tested. Valid values for versionId are between [1,2^31-1] or the string \"latest\".\"latest\" checks compatibility of the input schema with the last registered schema under the specified subject")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], verbose : Annotated[Optional[StrictBool], Field(description="Whether to return detailed error messages")] = None, **kwargs) -> CompatibilityCheckResponse:  # noqa: E501
        """Test schema compatibility against a particular schema subject-version  # noqa: E501

        Test input schema against a particular version of a subject's schema for compatibility. The compatibility level applied for the check is the configured compatibility level for the subject (http:get:: /config/(string: subject)). If this subject's compatibility level was never changed, then the global compatibility level applies (http:get:: /config).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.test_compatibility_by_subject_name(subject, version, register_schema_request, verbose, async_req=True)
        >>> result = thread.get()

        :param subject: Subject of the schema version against which compatibility is to be tested (required)
        :type subject: str
        :param version: Version of the subject's schema against which compatibility is to be tested. Valid values for versionId are between [1,2^31-1] or the string \"latest\".\"latest\" checks compatibility of the input schema with the last registered schema under the specified subject (required)
        :type version: str
        :param register_schema_request: Schema (required)
        :type register_schema_request: RegisterSchemaRequest
        :param verbose: Whether to return detailed error messages
        :type verbose: bool
        ...
        :rtype: CompatibilityCheckResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_compatibility_by_subject_name_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.test_compatibility_by_subject_name_with_http_info(subject, version, register_schema_request, verbose, **kwargs)  # noqa: E501

    @validate_arguments
    def test_compatibility_by_subject_name_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Subject of the schema version against which compatibility is to be tested")], version : Annotated[StrictStr, Field(..., description="Version of the subject's schema against which compatibility is to be tested. Valid values for versionId are between [1,2^31-1] or the string \"latest\".\"latest\" checks compatibility of the input schema with the last registered schema under the specified subject")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], verbose : Annotated[Optional[StrictBool], Field(description="Whether to return detailed error messages")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Test schema compatibility against a particular schema subject-version  # noqa: E501
        ...
        >>> thread = api.test_compatibility_by_subject_name_with_http_info(subject, version, register_schema_request, verbose, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CompatibilityCheckResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    ...
                    " to method test_compatibility_by_subject_name" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/compatibility/subjects/{subject}/versions/{version}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def test_compatibility_for_subject(self, subject : Annotated[StrictStr, Field(..., description="Subject of the schema version against which compatibility is to be tested")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], verbose : Annotated[Optional[StrictBool], Field(description="Whether to return detailed error messages")] = None, **kwargs) -> CompatibilityCheckResponse:  # noqa: E501
        """Test schema compatibility against all schemas under a subject  # noqa: E501
        ...
        >>> thread = api.test_compatibility_for_subject(subject, register_schema_request, verbose, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the test_compatibility_for_subject_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.test_compatibility_for_subject_with_http_info(subject, register_schema_request, verbose, **kwargs)  # noqa: E501

    @validate_arguments
    def test_compatibility_for_subject_with_http_info(self, subject : Annotated[StrictStr, Field(..., description="Subject of the schema version against which compatibility is to be tested")], register_schema_request : Annotated[RegisterSchemaRequest, Field(..., description="Schema")], verbose : Annotated[Optional[StrictBool], Field(description="Whether to return detailed error messages")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Test schema compatibility against all schemas under a subject  # noqa: E501
        ...
        >>> thread = api.test_compatibility_for_subject_with_http_info(subject, register_schema_request, verbose, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params and _key != "_host_index":
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_compatibility_for_subject" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/compatibility/subjects/{subject}/versions', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
